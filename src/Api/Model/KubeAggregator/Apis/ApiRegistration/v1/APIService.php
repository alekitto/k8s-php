...
#[Kubernetes\Operation('get', path: '/apis/apiregistration.k8s.io/v1/apiservices/{name}', response: 'self')]
#[Kubernetes\Operation('get-status', path: '/apis/apiregistration.k8s.io/v1/apiservices/{name}/status', response: 'self')]
#[Kubernetes\Operation('post', path: '/apis/apiregistration.k8s.io/v1/apiservices', body: 'model', response: 'self')]
#[Kubernetes\Operation('delete', path: '/apis/apiregistration.k8s.io/v1/apiservices/{name}')]
#[Kubernetes\Operation('put', path: '/apis/apiregistration.k8s.io/v1/apiservices/{name}', body: 'model', response: 'self')]
#[Kubernetes\Operation('put-status', path: '/apis/apiregistration.k8s.io/v1/apiservices/{name}/status', body: 'model', response: 'self')]
...
#[Kubernetes\Operation('patch', path: '/apis/apiregistration.k8s.io/v1/apiservices/{name}', body: 'patch', response: 'self')]
#[Kubernetes\Operation('patch-status', path: '/apis/apiregistration.k8s.io/v1/apiservices/{name}/status', body: 'patch', response: 'self')]
#[Kubernetes\Operation('list-all', path: '/apis/apiregistration.k8s.io/v1/apiservices', response: APIServiceList::class)]
class APIService
{
    ...
    protected string $kind = 'APIService';

    #[Kubernetes\Attribute('metadata', type: AttributeType::Model, model: ObjectMeta::class)]
    protected ObjectMeta $metadata;

    #[Kubernetes\Attribute('spec', type: AttributeType::Model, model: APIServiceSpec::class)]
    protected APIServiceSpec $spec;

    #[Kubernetes\Attribute('status', type: AttributeType::Model, model: APIServiceStatus::class)]
    protected APIServiceStatus|null $status = null;

    public function __construct(string|null $name, int $groupPriorityMinimum, int $versionPriority)
    {
    ...
    /**
     * GroupPriorityMinimum is the priority this group should have at least. Higher priority means that the
     * group is preferred by clients over lower priority ones. Note that other versions of this group might
     * specify even higher GroupPriorityMinimum values such that the whole group gets a higher priority.
     ...
     * @return static
     */
    public function setGroupPriorityMinimum(int $groupPriorityMinimum): static
    {
     ...
     */
    public function isInsecureSkipTLSVerify(): bool|null
    {
     ...
     * @return static
     */
    public function setIsInsecureSkipTLSVerify(bool $insecureSkipTLSVerify): static
    {
     ...
     * @return static
     */
    public function setVersionPriority(int $versionPriority): static
    {
     ...
     * @return static
     */
    public function setSpec(APIServiceSpec $spec): static
    {
        $this->spec = $spec;
     ...
     */
    public function getStatus(): APIServiceStatus|null
    {
        return $this->status;
    }
     ...
     * @return static
     */
    public function setStatus(APIServiceStatus $status): static
    {
        $this->status = $status;
