...
class APIServiceSpec
{
    ...
    #[Kubernetes\Attribute('groupPriorityMinimum', required: true)]
    protected int $groupPriorityMinimum;

    #[Kubernetes\Attribute('insecureSkipTLSVerify')]
    protected bool|null $insecureSkipTLSVerify = null;
    ...
    #[Kubernetes\Attribute('versionPriority', required: true)]
    protected int $versionPriority;
