...
class APIServiceList implements IteratorAggregate
{
    ...
    protected string|null $apiVersion = 'apiregistration.k8s.io/v1';

    /** @var iterable|APIService[] */
    #[Kubernetes\Attribute('items', type: AttributeType::Collection, model: APIService::class, required: true)]
    protected iterable $items;

    #[Kubernetes\Attribute('kind')]
    protected string|null $kind = 'APIServiceList';
    ...
    /** @return static */
    public function addItems(APIService $item): static
    {
        if (! $this->items) {
