...
class JobList implements IteratorAggregate
{
    ...
    /** @var iterable|Job[] */
    #[Kubernetes\Attribute('items', type: AttributeType::Collection, model: Job::class, required: true)]
    protected iterable $items;

    #[Kubernetes\Attribute('kind')]
    protected string|null $kind = 'JobList';
    ...
    /** @return static */
    public function addItems(Job $item): static
    {
        if (! $this->items) {
