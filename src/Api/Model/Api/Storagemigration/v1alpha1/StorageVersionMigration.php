 ...
 */
#[Kubernetes\Kind('StorageVersionMigration', group: 'storagemigration.k8s.io', version: 'v1alpha1')]
...
#[Kubernetes\Operation('patch', path: '/apis/storagemigration.k8s.io/v1alpha1/storageversionmigrations/{name}', body: 'patch', response: 'self')]
#[Kubernetes\Operation(
    'patch-status',
    path: '/apis/storagemigration.k8s.io/v1alpha1/storageversionmigrations/{name}/status',
    body: 'patch',
...
#[Kubernetes\Operation(
    'list-all',
    path: '/apis/storagemigration.k8s.io/v1alpha1/storageversionmigrations',
    response: 'Kcs\K8s\Api\Model\Api\Storagemigration\v1alpha1\StorageVersionMigrationList',
)]
class StorageVersionMigration
{
    #[Kubernetes\Attribute('apiVersion')]
    protected string $apiVersion = 'storagemigration.k8s.io/v1alpha1';

    #[Kubernetes\Attribute('kind')]
    protected string $kind = 'StorageVersionMigration';

    #[Kubernetes\Attribute('metadata', type: AttributeType::Model, model: ObjectMeta::class)]
    protected ObjectMeta $metadata;

    #[Kubernetes\Attribute('spec', type: AttributeType::Model, model: StorageVersionMigrationSpec::class)]
    protected StorageVersionMigrationSpec $spec;

    #[Kubernetes\Attribute('status', type: AttributeType::Model, model: StorageVersionMigrationStatus::class)]
    protected StorageVersionMigrationStatus|null $status = null;

    public function __construct(string|null $name, GroupVersionResource $resource)
    {
        $this->metadata = new ObjectMeta($name);
        $this->spec = new StorageVersionMigrationSpec($resource);
    }
    ...
    {
        return $this->spec->getContinueToken();
    }
    ...
    {
        $this->spec->setContinueToken($continueToken);
    ...
    {
        $this->spec->setResource($resource);
     ...
     */
    public function getSpec(): StorageVersionMigrationSpec
    {
        return $this->spec;
    }
     ...
     * @return static
     */
    public function setSpec(StorageVersionMigrationSpec $spec): static
    {
        $this->spec = $spec;
     ...
     */
    public function getStatus(): StorageVersionMigrationStatus|null
    {
        return $this->status;
    }
     ...
     * @return static
     */
    public function setStatus(StorageVersionMigrationStatus $status): static
    {
        $this->status = $status;
