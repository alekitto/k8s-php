 ...
 *
 * @implements IteratorAggregate<int, StorageVersionMigration>
 */
#[Kubernetes\Kind('StorageVersionMigrationList', group: 'storagemigration.k8s.io', version: 'v1alpha1')]
class StorageVersionMigrationList implements IteratorAggregate
{
    #[Kubernetes\Attribute('apiVersion')]
    protected string|null $apiVersion = 'storagemigration.k8s.io/v1alpha1';

    /** @var iterable|StorageVersionMigration[] */
    #[Kubernetes\Attribute('items', type: AttributeType::Collection, model: StorageVersionMigration::class, required: true)]
    protected iterable $items;

    #[Kubernetes\Attribute('kind')]
    protected string|null $kind = 'StorageVersionMigrationList';

    #[Kubernetes\Attribute('metadata', type: AttributeType::Model, model: ListMeta::class)]
    protected ListMeta|null $metadata = null;

    /** @param iterable|StorageVersionMigration[] $items */
    ...
    /** @return ArrayIterator|iterable|StorageVersionMigration[] */
     ...
     *
     * @return iterable|StorageVersionMigration[]
     */
    ...
    /** @return static */
    public function addItems(StorageVersionMigration $item): static
    {
        if (! $this->items) {
