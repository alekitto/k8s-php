...
class PriorityClassList implements IteratorAggregate
{
    ...
    #[Kubernetes\Attribute('items', type: AttributeType::Collection, model: PriorityClass::class, required: true)]
    protected iterable $items;

    #[Kubernetes\Attribute('kind')]
    protected string|null $kind = 'PriorityClassList';
    ...
    /** @return static */
    public function addItems(PriorityClass $item): static
    {
        if (! $this->items) {
