...
namespace Kcs\K8s\Api\Model\Api\Scheduling\v1;
...
#[Kubernetes\Operation('patch', path: '/apis/scheduling.k8s.io/v1/priorityclasses/{name}', body: 'patch', response: 'self')]
#[Kubernetes\Operation('list-all', path: '/apis/scheduling.k8s.io/v1/priorityclasses', response: PriorityClassList::class)]
class PriorityClass
{
    #[Kubernetes\Attribute('apiVersion')]
    protected string|null $apiVersion = 'scheduling.k8s.io/v1';

    #[Kubernetes\Attribute('description')]
    protected string|null $description = null;

    #[Kubernetes\Attribute('globalDefault')]
    protected bool|null $globalDefault = null;

    #[Kubernetes\Attribute('kind')]
    protected string|null $kind = 'PriorityClass';
    ...
    public function __construct(string|null $name, int $value)
    {
     ...
     */
    public function isGlobalDefault(): bool|null
    {
     ...
     * @return static
     */
    public function setIsGlobalDefault(bool $globalDefault): static
    {
