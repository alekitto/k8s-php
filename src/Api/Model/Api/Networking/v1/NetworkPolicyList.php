...
class NetworkPolicyList implements IteratorAggregate
{
    ...
    protected string|null $apiVersion = 'networking.k8s.io/v1';

    /** @var iterable|NetworkPolicy[] */
    #[Kubernetes\Attribute('items', type: AttributeType::Collection, model: NetworkPolicy::class, required: true)]
    protected iterable $items;

    #[Kubernetes\Attribute('kind')]
    protected string|null $kind = 'NetworkPolicyList';
    ...
    /** @return static */
    public function addItems(NetworkPolicy $item): static
    {
        if (! $this->items) {
