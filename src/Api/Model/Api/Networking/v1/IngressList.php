...
class IngressList implements IteratorAggregate
{
    ...
    #[Kubernetes\Attribute('items', type: AttributeType::Collection, model: Ingress::class, required: true)]
    protected iterable $items;

    #[Kubernetes\Attribute('kind')]
    protected string|null $kind = 'IngressList';
    ...
    /** @return static */
    public function addItems(Ingress $item): static
    {
        if (! $this->items) {
