...
#[Kubernetes\Operation('get', path: '/apis/networking.k8s.io/v1/namespaces/{namespace}/ingresses/{name}', response: 'self')]
#[Kubernetes\Operation('get-status', path: '/apis/networking.k8s.io/v1/namespaces/{namespace}/ingresses/{name}/status', response: 'self')]
#[Kubernetes\Operation('post', path: '/apis/networking.k8s.io/v1/namespaces/{namespace}/ingresses', body: 'model', response: 'self')]
#[Kubernetes\Operation('delete', path: '/apis/networking.k8s.io/v1/namespaces/{namespace}/ingresses/{name}')]
...
class Ingress
{
    ...
    #[Kubernetes\Attribute('spec', type: AttributeType::Model, model: IngressSpec::class)]
    protected IngressSpec $spec;

    #[Kubernetes\Attribute('status', type: AttributeType::Model, model: IngressStatus::class)]
    protected IngressStatus|null $status = null;
     ...
     * @return static
     */
    public function setSpec(IngressSpec $spec): static
    {
        $this->spec = $spec;
     ...
     * https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
     */
    public function getStatus(): IngressStatus|null
    {
        return $this->status;
    }
     ...
     * @return static
     */
    public function setStatus(IngressStatus $status): static
    {
        $this->status = $status;
