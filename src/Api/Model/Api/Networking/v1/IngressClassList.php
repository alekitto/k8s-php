...
class IngressClassList implements IteratorAggregate
{
    ...
    #[Kubernetes\Attribute('items', type: AttributeType::Collection, model: IngressClass::class, required: true)]
    protected iterable $items;

    #[Kubernetes\Attribute('kind')]
    protected string|null $kind = 'IngressClassList';
    ...
    /** @return static */
    public function addItems(IngressClass $item): static
    {
        if (! $this->items) {
