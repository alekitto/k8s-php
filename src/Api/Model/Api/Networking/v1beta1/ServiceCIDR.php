...
#[Kubernetes\Operation('delete', path: '/apis/networking.k8s.io/v1beta1/servicecidrs/{name}')]
...
#[Kubernetes\Operation('list-all', path: '/apis/networking.k8s.io/v1beta1/servicecidrs', response: ServiceCIDRList::class)]
class ServiceCIDR
{
    ...
    #[Kubernetes\Attribute('spec', type: AttributeType::Model, model: ServiceCIDRSpec::class)]
    protected ServiceCIDRSpec $spec;

    #[Kubernetes\Attribute('status', type: AttributeType::Model, model: ServiceCIDRStatus::class)]
    protected ServiceCIDRStatus|null $status = null;
     ...
     */
    public function getSpec(): ServiceCIDRSpec
    {
        return $this->spec;
    }
     ...
     * @return static
     */
    public function setSpec(ServiceCIDRSpec $spec): static
    {
        $this->spec = $spec;
     ...
     * https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
     */
    public function getStatus(): ServiceCIDRStatus|null
    {
        return $this->status;
    }
     ...
     * @return static
     */
    public function setStatus(ServiceCIDRStatus $status): static
    {
        $this->status = $status;
