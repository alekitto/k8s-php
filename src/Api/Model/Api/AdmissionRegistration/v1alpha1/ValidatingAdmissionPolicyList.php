 ...
 *
 * @implements IteratorAggregate<int, ValidatingAdmissionPolicy>
 */
#[Kubernetes\Kind('ValidatingAdmissionPolicyList', group: 'admissionregistration.k8s.io', version: 'v1alpha1')]
class ValidatingAdmissionPolicyList implements IteratorAggregate
{
    #[Kubernetes\Attribute('apiVersion')]
    protected string|null $apiVersion = 'admissionregistration.k8s.io/v1alpha1';

    /** @var iterable|ValidatingAdmissionPolicy[] */
    #[Kubernetes\Attribute('items', type: AttributeType::Collection, model: ValidatingAdmissionPolicy::class, required: true)]
    protected iterable $items;

    #[Kubernetes\Attribute('kind')]
    protected string|null $kind = 'ValidatingAdmissionPolicyList';

    #[Kubernetes\Attribute('metadata', type: AttributeType::Model, model: ListMeta::class)]
    protected ListMeta|null $metadata = null;

    /** @param iterable|ValidatingAdmissionPolicy[] $items */
    ...
    /** @return ArrayIterator|iterable|ValidatingAdmissionPolicy[] */
     ...
     *
     * @return iterable|ValidatingAdmissionPolicy[]
     */
    ...
    /** @return static */
    public function addItems(ValidatingAdmissionPolicy $item): static
    {
        if (! $this->items) {
