 ...
 *
 * @implements IteratorAggregate<int, ValidatingAdmissionPolicyBinding>
 */
#[Kubernetes\Kind('ValidatingAdmissionPolicyBindingList', group: 'admissionregistration.k8s.io', version: 'v1alpha1')]
class ValidatingAdmissionPolicyBindingList implements IteratorAggregate
{
    ...
    /** @return ArrayIterator|iterable|ValidatingAdmissionPolicyBinding[] */
    ...
    /** @return static */
    public function addItems(ValidatingAdmissionPolicyBinding $item): static
    {
        if (! $this->items) {
