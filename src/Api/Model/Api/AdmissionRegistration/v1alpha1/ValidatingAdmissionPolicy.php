 ...
 */
#[Kubernetes\Kind('ValidatingAdmissionPolicy', group: 'admissionregistration.k8s.io', version: 'v1alpha1')]
#[Kubernetes\Operation('get', path: '/apis/admissionregistration.k8s.io/v1alpha1/validatingadmissionpolicies/{name}', response: 'self')]
...
class ValidatingAdmissionPolicy
{
    ...
    protected string $apiVersion = 'admissionregistration.k8s.io/v1alpha1';
