 ...
 */
#[Kubernetes\Kind('ValidatingAdmissionPolicyList', group: 'admissionregistration.k8s.io', version: 'v1beta1')]
class ValidatingAdmissionPolicyList implements IteratorAggregate
{
    #[Kubernetes\Attribute('apiVersion')]
    protected string|null $apiVersion = 'admissionregistration.k8s.io/v1beta1';
