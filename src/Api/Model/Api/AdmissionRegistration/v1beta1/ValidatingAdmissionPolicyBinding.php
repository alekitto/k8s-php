 ...
 * its own CEL budget.
 */
#[Kubernetes\Kind('ValidatingAdmissionPolicyBinding', group: 'admissionregistration.k8s.io', version: 'v1beta1')]
#[Kubernetes\Operation('get', path: '/apis/admissionregistration.k8s.io/v1beta1/validatingadmissionpolicybindings/{name}', response: 'self')]
...
#[Kubernetes\Operation('delete', path: '/apis/admissionregistration.k8s.io/v1beta1/validatingadmissionpolicybindings/{name}')]
#[Kubernetes\Operation(
    'put',
