...
#[Kubernetes\Operation(
    'list-all',
    path: '/apis/admissionregistration.k8s.io/v1/validatingwebhookconfigurations',
    response: 'Kcs\K8s\Api\Model\Api\AdmissionRegistration\v1\ValidatingWebhookConfigurationList',
)]
class ValidatingWebhookConfiguration
{
    ...
    protected string|null $kind = 'ValidatingWebhookConfiguration';
    ...
    #[Kubernetes\Attribute('webhooks', type: AttributeType::Collection, model: ValidatingWebhook::class)]
    ...
    /** @return static */
    public function addWebhooks(ValidatingWebhook $webhook): static
    {
        if (! $this->webhooks) {
