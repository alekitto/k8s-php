...
class MutatingWebhookConfigurationList implements IteratorAggregate
{
    ...
    #[Kubernetes\Attribute('items', type: AttributeType::Collection, model: MutatingWebhookConfiguration::class, required: true)]
    protected iterable $items;

    #[Kubernetes\Attribute('kind')]
    protected string|null $kind = 'MutatingWebhookConfigurationList';
    ...
    /** @return static */
    public function addItems(MutatingWebhookConfiguration $item): static
    {
        if (! $this->items) {
