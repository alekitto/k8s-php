...
class CSIStorageCapacity
{
    ...
    protected string|null $capacity = null;

    #[Kubernetes\Attribute('kind')]
    protected string|null $kind = 'CSIStorageCapacity';

    #[Kubernetes\Attribute('maximumVolumeSize')]
    protected string|null $maximumVolumeSize = null;

    #[Kubernetes\Attribute('metadata', type: AttributeType::Model, model: ObjectMeta::class)]
    protected ObjectMeta|null $metadata = null;

    #[Kubernetes\Attribute('nodeTopology', type: AttributeType::Model, model: LabelSelector::class)]
    protected LabelSelector|null $nodeTopology = null;

    #[Kubernetes\Attribute('storageClassName', required: true)]
    protected string $storageClassName;

    public function __construct(string|null $name, string $storageClassName)
    {
     ...
     */
    public function getMaximumVolumeSize(): string
    {
     ...
     * @return static
     */
    public function setMaximumVolumeSize(string $maximumVolumeSize): static
    {
    ...
    /**
     * Standard object's metadata. The name has no particular meaning. It must be a DNS subdomain (dots
     ...
     */
    public function getNodeTopology(): LabelSelector|null
    {
     ...
     * @return static
     */
    public function setNodeTopology(LabelSelector $nodeTopology): static
    {
    ...
    /**
     * storageClassName represents the name of the StorageClass that the reported capacity applies to. It
     * must meet the same requirements as the name of a StorageClass object (non-empty, DNS subdomain). If
     * that object no longer exists, the CSIStorageCapacity object is obsolete and should be removed by its
