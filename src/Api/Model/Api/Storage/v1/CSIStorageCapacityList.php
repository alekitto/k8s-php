...
class CSIStorageCapacityList implements IteratorAggregate
{
    ...
    #[Kubernetes\Attribute('items', type: AttributeType::Collection, model: CSIStorageCapacity::class, required: true)]
    protected iterable $items;

    #[Kubernetes\Attribute('kind')]
    protected string|null $kind = 'CSIStorageCapacityList';
    ...
    /** @return static */
    public function addItems(CSIStorageCapacity $item): static
    {
        if (! $this->items) {
