...
class CSINodeList implements IteratorAggregate
{
    ...
    #[Kubernetes\Attribute('items', type: AttributeType::Collection, model: CSINode::class, required: true)]
    protected iterable $items;

    #[Kubernetes\Attribute('kind')]
    protected string|null $kind = 'CSINodeList';
    ...
    /** @return static */
    public function addItems(CSINode $item): static
    {
        if (! $this->items) {
