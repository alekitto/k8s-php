...
use Kcs\K8s\Api\Model\Api\Core\v1\TopologySelectorTerm;
...
#[Kubernetes\Operation('patch', path: '/apis/storage.k8s.io/v1/storageclasses/{name}', body: 'patch', response: 'self')]
#[Kubernetes\Operation('list-all', path: '/apis/storage.k8s.io/v1/storageclasses', response: StorageClassList::class)]
class StorageClass
{
    #[Kubernetes\Attribute('allowVolumeExpansion')]
    protected bool|null $allowVolumeExpansion = null;

    /** @var iterable|TopologySelectorTerm[]|null */
    #[Kubernetes\Attribute('allowedTopologies', type: AttributeType::Collection, model: TopologySelectorTerm::class)]
    protected $allowedTopologies = null;

    #[Kubernetes\Attribute('apiVersion')]
    protected string|null $apiVersion = 'storage.k8s.io/v1';

    #[Kubernetes\Attribute('kind')]
    protected string|null $kind = 'StorageClass';
    ...
    #[Kubernetes\Attribute('provisioner', required: true)]
    protected string $provisioner;

    #[Kubernetes\Attribute('reclaimPolicy')]
    protected string|null $reclaimPolicy = null;

    #[Kubernetes\Attribute('volumeBindingMode')]
    protected string|null $volumeBindingMode = null;

    public function __construct(string|null $name, string $provisioner)
    {
     ...
     */
    public function isAllowVolumeExpansion(): bool|null
    {
     ...
     * @return static
     */
    public function setIsAllowVolumeExpansion(bool $allowVolumeExpansion): static
    {
     ...
     * volume plugin defines its own supported topology specifications. An empty TopologySelectorTerm list
     * means there is no topology restriction. This field is only honored by servers that enable the
     * VolumeScheduling feature.
     *
     * @return iterable|TopologySelectorTerm[]
     */
    public function getAllowedTopologies(): iterable|null
    {
     ...
     * @return static
     */
    public function setAllowedTopologies(iterable $allowedTopologies): static
    {
    ...
    /** @return static */
    public function addAllowedTopologies(TopologySelectorTerm $allowedTopologie): static
    {
    ...
    /**
     * mountOptions controls the mountOptions for dynamically provisioned PersistentVolumes of this storage
     * class. e.g. ["ro", "soft"]. Not validated - mount of the PVs will simply fail if one is invalid.
     */
     ...
     * @return static
     */
    public function setProvisioner(string $provisioner): static
    {
        $this->provisioner = $provisioner;
    ...
    /**
     * reclaimPolicy controls the reclaimPolicy for dynamically provisioned PersistentVolumes of this
     * storage class. Defaults to Delete.
     */
     ...
     * @return static
     */
    public function setReclaimPolicy(string $reclaimPolicy): static
    {
     ...
     * @return static
     */
    public function setVolumeBindingMode(string $volumeBindingMode): static
    {
