...
class StorageClassList implements IteratorAggregate
{
    ...
    #[Kubernetes\Attribute('items', type: AttributeType::Collection, model: StorageClass::class, required: true)]
    protected iterable $items;

    #[Kubernetes\Attribute('kind')]
    protected string|null $kind = 'StorageClassList';
    ...
    /** @return static */
    public function addItems(StorageClass $item): static
    {
        if (! $this->items) {
