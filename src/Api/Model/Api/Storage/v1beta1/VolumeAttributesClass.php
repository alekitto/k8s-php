...
namespace Kcs\K8s\Api\Model\Api\Storage\v1beta1;
 ...
 */
#[Kubernetes\Kind('VolumeAttributesClass', group: 'storage.k8s.io', version: 'v1beta1')]
#[Kubernetes\Operation('get', path: '/apis/storage.k8s.io/v1beta1/volumeattributesclasses/{name}', response: 'self')]
#[Kubernetes\Operation('post', path: '/apis/storage.k8s.io/v1beta1/volumeattributesclasses', body: 'model', response: 'self')]
#[Kubernetes\Operation('delete', path: '/apis/storage.k8s.io/v1beta1/volumeattributesclasses/{name}')]
#[Kubernetes\Operation('put', path: '/apis/storage.k8s.io/v1beta1/volumeattributesclasses/{name}', body: 'model', response: 'self')]
...
#[Kubernetes\Operation('patch', path: '/apis/storage.k8s.io/v1beta1/volumeattributesclasses/{name}', body: 'patch', response: 'self')]
#[Kubernetes\Operation('list-all', path: '/apis/storage.k8s.io/v1beta1/volumeattributesclasses', response: VolumeAttributesClassList::class)]
class VolumeAttributesClass
{
    #[Kubernetes\Attribute('apiVersion')]
    protected string|null $apiVersion = 'storage.k8s.io/v1beta1';
