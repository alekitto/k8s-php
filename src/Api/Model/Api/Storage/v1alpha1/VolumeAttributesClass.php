...
namespace Kcs\K8s\Api\Model\Api\Storage\v1alpha1;
 ...
 * driver. The class can be specified during dynamic provisioning of PersistentVolumeClaims, and
 * changed in the PersistentVolumeClaim spec after provisioning.
 */
#[Kubernetes\Kind('VolumeAttributesClass', group: 'storage.k8s.io', version: 'v1alpha1')]
#[Kubernetes\Operation('get', path: '/apis/storage.k8s.io/v1alpha1/volumeattributesclasses/{name}', response: 'self')]
#[Kubernetes\Operation('post', path: '/apis/storage.k8s.io/v1alpha1/volumeattributesclasses', body: 'model', response: 'self')]
#[Kubernetes\Operation('delete', path: '/apis/storage.k8s.io/v1alpha1/volumeattributesclasses/{name}', response: 'self')]
#[Kubernetes\Operation('put', path: '/apis/storage.k8s.io/v1alpha1/volumeattributesclasses/{name}', body: 'model', response: 'self')]
...
#[Kubernetes\Operation('patch', path: '/apis/storage.k8s.io/v1alpha1/volumeattributesclasses/{name}', body: 'patch', response: 'self')]
#[Kubernetes\Operation('list-all', path: '/apis/storage.k8s.io/v1alpha1/volumeattributesclasses', response: VolumeAttributesClassList::class)]
class VolumeAttributesClass
{
    #[Kubernetes\Attribute('apiVersion')]
    protected string|null $apiVersion = 'storage.k8s.io/v1alpha1';

    #[Kubernetes\Attribute('driverName', required: true)]
    protected string $driverName;

    #[Kubernetes\Attribute('kind')]
    protected string|null $kind = 'VolumeAttributesClass';
    ...
    /**
     * parameters hold volume attributes defined by the CSI driver. These values are opaque to the
     * Kubernetes and are passed directly to the CSI driver. The underlying storage provider supports
     ...
     *
     * This field is required and must contain at least one key/value pair. The keys cannot be empty, and
     * the maximum number of parameters is 512, with a cumulative max size of 256K. If the CSI driver
     * rejects invalid parameters, the target PersistentVolumeClaim will be set to an "Infeasible" state in
     * the modifyVolumeStatus field.
     */
