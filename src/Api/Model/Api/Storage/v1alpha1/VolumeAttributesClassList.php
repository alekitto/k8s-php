 ...
 *
 * @implements IteratorAggregate<int, VolumeAttributesClass>
 */
#[Kubernetes\Kind('VolumeAttributesClassList', group: 'storage.k8s.io', version: 'v1alpha1')]
class VolumeAttributesClassList implements IteratorAggregate
{
    #[Kubernetes\Attribute('apiVersion')]
    protected string|null $apiVersion = 'storage.k8s.io/v1alpha1';

    /** @var iterable|VolumeAttributesClass[] */
    #[Kubernetes\Attribute('items', type: AttributeType::Collection, model: VolumeAttributesClass::class, required: true)]
    protected iterable $items;

    #[Kubernetes\Attribute('kind')]
    protected string|null $kind = 'VolumeAttributesClassList';

    #[Kubernetes\Attribute('metadata', type: AttributeType::Model, model: ListMeta::class)]
    protected ListMeta|null $metadata = null;

    /** @param iterable|VolumeAttributesClass[] $items */
    ...
    /** @return ArrayIterator|iterable|VolumeAttributesClass[] */
     ...
     *
     * @return iterable|VolumeAttributesClass[]
     */
    ...
    /** @return static */
    public function addItems(VolumeAttributesClass $item): static
    {
        if (! $this->items) {
