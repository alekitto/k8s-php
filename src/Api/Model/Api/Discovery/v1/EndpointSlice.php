...
class EndpointSlice
{
    ...
    protected string|null $apiVersion = 'discovery.k8s.io/v1';

    /** @var iterable|Endpoint[] */
    #[Kubernetes\Attribute('endpoints', type: AttributeType::Collection, model: Endpoint::class, required: true)]
    protected iterable $endpoints;

    #[Kubernetes\Attribute('kind')]
    protected string|null $kind = 'EndpointSlice';
    ...
    public function __construct(string|null $name, string $addressType, iterable $endpoints)
    {
     ...
     * @return static
     */
    public function setEndpoints(iterable $endpoints): static
    {
    ...
    /** @return static */
    public function addEndpoints(Endpoint $endpoint): static
    {
        if (! $this->endpoints) {
