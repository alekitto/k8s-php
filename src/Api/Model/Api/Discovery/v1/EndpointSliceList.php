...
class EndpointSliceList implements IteratorAggregate
{
    ...
    #[Kubernetes\Attribute('items', type: AttributeType::Collection, model: EndpointSlice::class, required: true)]
    protected iterable $items;

    #[Kubernetes\Attribute('kind')]
    protected string|null $kind = 'EndpointSliceList';
    ...
    /** @return static */
    public function addItems(EndpointSlice $item): static
    {
        if (! $this->items) {
