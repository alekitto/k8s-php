...
class EventList implements IteratorAggregate
{
    ...
    /** @var iterable|Event[] */
    #[Kubernetes\Attribute('items', type: AttributeType::Collection, model: Event::class, required: true)]
    protected iterable $items;

    #[Kubernetes\Attribute('kind')]
    protected string|null $kind = 'EventList';
    ...
    /** @return static */
    public function addItems(Event $item): static
    {
        if (! $this->items) {
