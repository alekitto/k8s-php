...
class LeaseList implements IteratorAggregate
{
    ...
    protected string|null $apiVersion = 'coordination.k8s.io/v1';

    /** @var iterable|Lease[] */
    #[Kubernetes\Attribute('items', type: AttributeType::Collection, model: Lease::class, required: true)]
    protected iterable $items;

    #[Kubernetes\Attribute('kind')]
    protected string|null $kind = 'LeaseList';
    ...
    /** @return static */
    public function addItems(Lease $item): static
    {
        if (! $this->items) {
