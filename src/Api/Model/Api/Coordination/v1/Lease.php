...
class Lease
{
    ...
    protected string $apiVersion = 'coordination.k8s.io/v1';

    #[Kubernetes\Attribute('kind')]
    protected string $kind = 'Lease';

    #[Kubernetes\Attribute('metadata', type: AttributeType::Model, model: ObjectMeta::class)]
    protected ObjectMeta $metadata;

    #[Kubernetes\Attribute('spec', type: AttributeType::Model, model: LeaseSpec::class)]
    protected LeaseSpec $spec;
     ...
     * @return static
     */
    public function setSpec(LeaseSpec $spec): static
    {
        $this->spec = $spec;
