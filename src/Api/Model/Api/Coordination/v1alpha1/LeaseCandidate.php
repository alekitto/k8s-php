 ...
 */
#[Kubernetes\Kind('LeaseCandidate', group: 'coordination.k8s.io', version: 'v1alpha1')]
#[Kubernetes\Operation('get', path: '/apis/coordination.k8s.io/v1alpha1/namespaces/{namespace}/leasecandidates/{name}', response: 'self')]
...
#[Kubernetes\Operation('delete', path: '/apis/coordination.k8s.io/v1alpha1/namespaces/{namespace}/leasecandidates/{name}')]
#[Kubernetes\Operation(
    'watch',
    path: '/apis/coordination.k8s.io/v1alpha1/namespaces/{namespace}/leasecandidates',
...
#[Kubernetes\Operation(
    'list',
    path: '/apis/coordination.k8s.io/v1alpha1/namespaces/{namespace}/leasecandidates',
    response: LeaseCandidateList::class,
)]
#[Kubernetes\Operation('list-all', path: '/apis/coordination.k8s.io/v1alpha1/leasecandidates', response: LeaseCandidateList::class)]
class LeaseCandidate
{
    #[Kubernetes\Attribute('apiVersion')]
    protected string $apiVersion = 'coordination.k8s.io/v1alpha1';

    #[Kubernetes\Attribute('kind')]
    protected string $kind = 'LeaseCandidate';

    #[Kubernetes\Attribute('metadata', type: AttributeType::Model, model: ObjectMeta::class)]
    protected ObjectMeta $metadata;

    #[Kubernetes\Attribute('spec', type: AttributeType::Model, model: LeaseCandidateSpec::class)]
    protected LeaseCandidateSpec $spec;

    /** @param string[] $preferredStrategies */
    public function __construct(string|null $name, string $leaseName, array $preferredStrategies)
    {
        $this->metadata = new ObjectMeta($name);
        $this->spec = new LeaseCandidateSpec($leaseName, $preferredStrategies);
    }
    ...
    {
        return $this->spec->getBinaryVersion();
    }
    ...
    {
        $this->spec->setBinaryVersion($binaryVersion);
    ...
    {
        return $this->spec->getEmulationVersion();
    }
    ...
    {
        $this->spec->setEmulationVersion($emulationVersion);
    ...
    {
        $this->spec->setLeaseName($leaseName);
    ...
    {
        $this->spec->setPingTime($pingTime);
    ...
    {
        return $this->spec->getPreferredStrategies();
    }
    ...
    {
        $this->spec->setPreferredStrategies($preferredStrategies);
     ...
     */
    public function getSpec(): LeaseCandidateSpec
    {
        return $this->spec;
    }
     ...
     * @return static
     */
    public function setSpec(LeaseCandidateSpec $spec): static
    {
        $this->spec = $spec;
