 ...
 *
 * @implements IteratorAggregate<int, LeaseCandidate>
 */
#[Kubernetes\Kind('LeaseCandidateList', group: 'coordination.k8s.io', version: 'v1alpha1')]
class LeaseCandidateList implements IteratorAggregate
{
    #[Kubernetes\Attribute('apiVersion')]
    protected string|null $apiVersion = 'coordination.k8s.io/v1alpha1';

    /** @var iterable|LeaseCandidate[] */
    #[Kubernetes\Attribute('items', type: AttributeType::Collection, model: LeaseCandidate::class, required: true)]
    protected iterable $items;

    #[Kubernetes\Attribute('kind')]
    protected string|null $kind = 'LeaseCandidateList';

    #[Kubernetes\Attribute('metadata', type: AttributeType::Model, model: ListMeta::class)]
    protected ListMeta|null $metadata = null;

    /** @param iterable|LeaseCandidate[] $items */
    ...
    /** @return ArrayIterator|iterable|LeaseCandidate[] */
     ...
     *
     * @return iterable|LeaseCandidate[]
     */
    ...
    /** @return static */
    public function addItems(LeaseCandidate $item): static
    {
        if (! $this->items) {
