...
#[Kubernetes\Operation('get', path: '/apis/autoscaling/v1/namespaces/{namespace}/horizontalpodautoscalers/{name}', response: 'self')]
#[Kubernetes\Operation(
    'get-status',
    path: '/apis/autoscaling/v1/namespaces/{namespace}/horizontalpodautoscalers/{name}/status',
    response: 'self',
)]
#[Kubernetes\Operation('post', path: '/apis/autoscaling/v1/namespaces/{namespace}/horizontalpodautoscalers', body: 'model', response: 'self')]
#[Kubernetes\Operation('delete', path: '/apis/autoscaling/v1/namespaces/{namespace}/horizontalpodautoscalers/{name}')]
#[Kubernetes\Operation(
    'watch',
...
class HorizontalPodAutoscaler
{
    ...
    protected string $apiVersion = 'autoscaling/v1';
