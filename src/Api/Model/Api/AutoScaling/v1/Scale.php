...
class Scale
{
    ...
    protected string $kind = 'Scale';

    #[Kubernetes\Attribute('metadata', type: AttributeType::Model, model: ObjectMeta::class)]
    protected ObjectMeta $metadata;

    #[Kubernetes\Attribute('spec', type: AttributeType::Model, model: ScaleSpec::class)]
    protected ScaleSpec $spec;

    #[Kubernetes\Attribute('status', type: AttributeType::Model, model: ScaleStatus::class)]
    protected ScaleStatus|null $status = null;
     ...
     * @return static
     */
    public function setSpec(ScaleSpec $spec): static
    {
        $this->spec = $spec;
     ...
     * Read-only.
     */
    public function getStatus(): ScaleStatus|null
    {
        return $this->status;
    }
}
