...
class HorizontalPodAutoscalerList implements IteratorAggregate
{
    ...
    protected string|null $apiVersion = 'autoscaling/v1';

    /** @var iterable|HorizontalPodAutoscaler[] */
    #[Kubernetes\Attribute('items', type: AttributeType::Collection, model: HorizontalPodAutoscaler::class, required: true)]
    protected iterable $items;

    #[Kubernetes\Attribute('kind')]
    protected string|null $kind = 'HorizontalPodAutoscalerList';
    ...
    /** @return static */
    public function addItems(HorizontalPodAutoscaler $item): static
    {
        if (! $this->items) {
