...
class CertificateSigningRequestList implements IteratorAggregate
{
    ...
    protected string|null $apiVersion = 'certificates.k8s.io/v1';

    /** @var iterable|CertificateSigningRequest[] */
    #[Kubernetes\Attribute('items', type: AttributeType::Collection, model: CertificateSigningRequest::class, required: true)]
    protected iterable $items;

    #[Kubernetes\Attribute('kind')]
    protected string|null $kind = 'CertificateSigningRequestList';
    ...
    /** @return static */
    public function addItems(CertificateSigningRequest $item): static
    {
        if (! $this->items) {
