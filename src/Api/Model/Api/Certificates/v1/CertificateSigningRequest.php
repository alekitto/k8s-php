...
#[Kubernetes\Operation('patch', path: '/apis/certificates.k8s.io/v1/certificatesigningrequests/{name}', body: 'patch', response: 'self')]
#[Kubernetes\Operation(
    'patch-status',
    path: '/apis/certificates.k8s.io/v1/certificatesigningrequests/{name}/status',
    body: 'patch',
...
#[Kubernetes\Operation(
    'list-all',
    path: '/apis/certificates.k8s.io/v1/certificatesigningrequests',
    response: 'Kcs\K8s\Api\Model\Api\Certificates\v1\CertificateSigningRequestList',
)]
class CertificateSigningRequest
{
    #[Kubernetes\Attribute('apiVersion')]
    protected string $apiVersion = 'certificates.k8s.io/v1';

    #[Kubernetes\Attribute('kind')]
    protected string $kind = 'CertificateSigningRequest';

    #[Kubernetes\Attribute('metadata', type: AttributeType::Model, model: ObjectMeta::class)]
    protected ObjectMeta $metadata;

    #[Kubernetes\Attribute('spec', type: AttributeType::Model, model: CertificateSigningRequestSpec::class, required: true)]
    protected CertificateSigningRequestSpec $spec;

    #[Kubernetes\Attribute('status', type: AttributeType::Model, model: CertificateSigningRequestStatus::class)]
    protected CertificateSigningRequestStatus|null $status = null;

    public function __construct(string|null $name, string $request, string $signerName)
    {
     ...
     * @return static
     */
    public function setSpec(CertificateSigningRequestSpec $spec): static
    {
        $this->spec = $spec;
     ...
     */
    public function getStatus(): CertificateSigningRequestStatus|null
    {
        return $this->status;
    }
     ...
     * @return static
     */
    public function setStatus(CertificateSigningRequestStatus $status): static
    {
        $this->status = $status;
