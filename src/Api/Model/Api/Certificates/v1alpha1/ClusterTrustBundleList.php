 ...
 *
 * @implements IteratorAggregate<int, ClusterTrustBundle>
 */
#[Kubernetes\Kind('ClusterTrustBundleList', group: 'certificates.k8s.io', version: 'v1alpha1')]
class ClusterTrustBundleList implements IteratorAggregate
{
    #[Kubernetes\Attribute('apiVersion')]
    protected string|null $apiVersion = 'certificates.k8s.io/v1alpha1';

    /** @var iterable|ClusterTrustBundle[] */
    #[Kubernetes\Attribute('items', type: AttributeType::Collection, model: ClusterTrustBundle::class, required: true)]
    protected iterable $items;

    #[Kubernetes\Attribute('kind')]
    protected string|null $kind = 'ClusterTrustBundleList';

    #[Kubernetes\Attribute('metadata', type: AttributeType::Model, model: ListMeta::class)]
    protected ListMeta|null $metadata = null;

    /** @param iterable|ClusterTrustBundle[] $items */
    ...
    /** @return ArrayIterator|iterable|ClusterTrustBundle[] */
     ...
     *
     * @return iterable|ClusterTrustBundle[]
     */
    ...
    /** @return static */
    public function addItems(ClusterTrustBundle $item): static
    {
        if (! $this->items) {
