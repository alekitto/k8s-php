...
/**
 * ResourceClassParameters defines resource requests for a ResourceClass in an in-tree format
 * understood by Kubernetes.
 */
#[Kubernetes\Kind('ResourceClassParameters', group: 'resource.k8s.io', version: 'v1alpha2')]
#[Kubernetes\Operation('get', path: '/apis/resource.k8s.io/v1alpha2/namespaces/{namespace}/resourceclassparameters/{name}', response: 'self')]
...
#[Kubernetes\Operation('delete', path: '/apis/resource.k8s.io/v1alpha2/namespaces/{namespace}/resourceclassparameters/{name}', response: 'self')]
#[Kubernetes\Operation(
    'watch',
    path: '/apis/resource.k8s.io/v1alpha2/namespaces/{namespace}/resourceclassparameters',
...
class ResourceClassParameters
{
    ...
    /** @var iterable|ResourceFilter[]|null */
    #[Kubernetes\Attribute('filters', type: AttributeType::Collection, model: ResourceFilter::class)]
    protected $filters = null;

    #[Kubernetes\Attribute('generatedFrom', type: AttributeType::Model, model: ResourceClassParametersReference::class)]
    protected ResourceClassParametersReference|null $generatedFrom = null;

    #[Kubernetes\Attribute('kind')]
    protected string|null $kind = 'ResourceClassParameters';

    #[Kubernetes\Attribute('metadata', type: AttributeType::Model, model: ObjectMeta::class)]
    protected ObjectMeta|null $metadata = null;

    /** @var iterable|VendorParameters[]|null */
    #[Kubernetes\Attribute('vendorParameters', type: AttributeType::Collection, model: VendorParameters::class)]
     ...
     *
     * @return iterable|ResourceFilter[]
     */
    public function getFilters(): iterable|null
    {
        return $this->filters;
    }
    ...
    /** @return static */
    public function addFilters(ResourceFilter $filter): static
    {
        if (! $this->filters) {
     ...
     * field is used to find the in-tree representation of the class parameters when the parameter
     * reference of the class refers to some unknown type.
     */
    public function getGeneratedFrom(): ResourceClassParametersReference|null
    {
     ...
     * @return static
     */
    public function setGeneratedFrom(ResourceClassParametersReference $generatedFrom): static
    {
    ...
    /**
     * VendorParameters are arbitrary setup parameters for all claims using this class. They are ignored
     * while allocating the claim. There must not be more than one entry per driver.
     *
     * @return iterable|VendorParameters[]
     */
    public function getVendorParameters(): iterable|null
    {
     ...
     * @return static
     */
    public function setVendorParameters(iterable $vendorParameters): static
    {
    ...
    /** @return static */
    public function addVendorParameters(VendorParameters $vendorParameter): static
    {
        if (! $this->vendorParameters) {
            $this->vendorParameters = new Collection();
        }

        $this->vendorParameters[] = $vendorParameter;
