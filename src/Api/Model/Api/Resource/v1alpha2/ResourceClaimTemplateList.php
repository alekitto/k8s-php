 ...
 *
 * @implements IteratorAggregate<int, ResourceClaimTemplate>
 */
#[Kubernetes\Kind('ResourceClaimTemplateList', group: 'resource.k8s.io', version: 'v1alpha2')]
class ResourceClaimTemplateList implements IteratorAggregate
{
    #[Kubernetes\Attribute('apiVersion')]
    protected string|null $apiVersion = 'resource.k8s.io/v1alpha2';

    /** @var iterable|ResourceClaimTemplate[] */
    #[Kubernetes\Attribute('items', type: AttributeType::Collection, model: ResourceClaimTemplate::class, required: true)]
    protected iterable $items;

    #[Kubernetes\Attribute('kind')]
    protected string|null $kind = 'ResourceClaimTemplateList';

    #[Kubernetes\Attribute('metadata', type: AttributeType::Model, model: ListMeta::class)]
    protected ListMeta|null $metadata = null;

    /** @param iterable|ResourceClaimTemplate[] $items */
    ...
    /** @return ArrayIterator|iterable|ResourceClaimTemplate[] */
     ...
     *
     * @return iterable|ResourceClaimTemplate[]
     */
    ...
    /** @return static */
    public function addItems(ResourceClaimTemplate $item): static
    {
        if (! $this->items) {
