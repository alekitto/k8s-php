...
/**
 * ResourceClaimParameters defines resource requests for a ResourceClaim in an in-tree format
 * understood by Kubernetes.
 */
#[Kubernetes\Kind('ResourceClaimParameters', group: 'resource.k8s.io', version: 'v1alpha2')]
#[Kubernetes\Operation('get', path: '/apis/resource.k8s.io/v1alpha2/namespaces/{namespace}/resourceclaimparameters/{name}', response: 'self')]
...
#[Kubernetes\Operation('delete', path: '/apis/resource.k8s.io/v1alpha2/namespaces/{namespace}/resourceclaimparameters/{name}', response: 'self')]
#[Kubernetes\Operation(
    'watch',
    path: '/apis/resource.k8s.io/v1alpha2/namespaces/{namespace}/resourceclaimparameters',
...
#[Kubernetes\Operation(
    'list',
    path: '/apis/resource.k8s.io/v1alpha2/namespaces/{namespace}/resourceclaimparameters',
    response: ResourceClaimParametersList::class,
)]
#[Kubernetes\Operation('list-all', path: '/apis/resource.k8s.io/v1alpha2/resourceclaimparameters', response: ResourceClaimParametersList::class)]
class ResourceClaimParameters
{
    #[Kubernetes\Attribute('apiVersion')]
    protected string|null $apiVersion = 'resource.k8s.io/v1alpha2';

    /** @var iterable|DriverRequests[]|null */
    #[Kubernetes\Attribute('driverRequests', type: AttributeType::Collection, model: DriverRequests::class)]
    protected $driverRequests = null;

    #[Kubernetes\Attribute('generatedFrom', type: AttributeType::Model, model: ResourceClaimParametersReference::class)]
    protected ResourceClaimParametersReference|null $generatedFrom = null;

    #[Kubernetes\Attribute('kind')]
    protected string|null $kind = 'ResourceClaimParameters';
    ...
    /**
     * DriverRequests describes all resources that are needed for the allocated claim. A single claim may
     * use resources coming from different drivers. For each driver, this array has at most one entry which
     * then may have one or more per-driver requests.
     *
     * May be empty, in which case the claim can always be allocated.
     *
     * @return iterable|DriverRequests[]
     */
    public function getDriverRequests(): iterable|null
    {
     ...
     * @return static
     */
    public function setDriverRequests(iterable $driverRequests): static
    {
    ...
    /** @return static */
    public function addDriverRequests(DriverRequests $driverRequest): static
    {
        if (! $this->driverRequests) {
            $this->driverRequests = new Collection();
        }
    ...
    /**
     * If this object was created from some other resource, then this links back to that resource. This
     * field is used to find the in-tree representation of the claim parameters when the parameter
     * reference of the claim refers to some unknown type.
     */
    public function getGeneratedFrom(): ResourceClaimParametersReference|null
    {
     ...
     * @return static
     */
    public function setGeneratedFrom(ResourceClaimParametersReference $generatedFrom): static
    {
    ...
    /**
     * Shareable indicates whether the allocated claim is meant to be shareable by multiple consumers at
     * the same time.
     */
