...
class ResourceClaimTemplateSpec
{
    ...
    /**
     * ObjectMeta may contain labels and annotations that will be copied into the PVC when creating it. No
    ...
    /**
     * Spec for the ResourceClaim. The entire content is copied unchanged into the ResourceClaim that gets
     * created from this template. The same fields as in a ResourceClaim are also valid here.
     */
