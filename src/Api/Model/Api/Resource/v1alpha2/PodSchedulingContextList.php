 ...
 *
 * @implements IteratorAggregate<int, PodSchedulingContext>
 */
#[Kubernetes\Kind('PodSchedulingContextList', group: 'resource.k8s.io', version: 'v1alpha2')]
class PodSchedulingContextList implements IteratorAggregate
{
    #[Kubernetes\Attribute('apiVersion')]
    protected string|null $apiVersion = 'resource.k8s.io/v1alpha2';

    /** @var iterable|PodSchedulingContext[] */
    #[Kubernetes\Attribute('items', type: AttributeType::Collection, model: PodSchedulingContext::class, required: true)]
    protected iterable $items;

    #[Kubernetes\Attribute('kind')]
    protected string|null $kind = 'PodSchedulingContextList';

    #[Kubernetes\Attribute('metadata', type: AttributeType::Model, model: ListMeta::class)]
    protected ListMeta|null $metadata = null;

    /** @param iterable|PodSchedulingContext[] $items */
    ...
    /** @return ArrayIterator|iterable|PodSchedulingContext[] */
     ...
     *
     * @return iterable|PodSchedulingContext[]
     */
    ...
    /** @return static */
    public function addItems(PodSchedulingContext $item): static
    {
        if (! $this->items) {
