...
#[Kubernetes\Operation('get', path: '/apis/resource.k8s.io/v1alpha2/namespaces/{namespace}/resourceclaims/{name}', response: 'self')]
#[Kubernetes\Operation(
    'get-status',
    path: '/apis/resource.k8s.io/v1alpha2/namespaces/{namespace}/resourceclaims/{name}/status',
    response: 'self',
)]
#[Kubernetes\Operation('post', path: '/apis/resource.k8s.io/v1alpha2/namespaces/{namespace}/resourceclaims', body: 'model', response: 'self')]
#[Kubernetes\Operation('delete', path: '/apis/resource.k8s.io/v1alpha2/namespaces/{namespace}/resourceclaims/{name}', response: 'self')]
#[Kubernetes\Operation(
    'watch',
...
class ResourceClaim
{
    ...
    public function __construct(string|null $name, string $resourceClassName)
    {
