 ...
 *
 * @implements IteratorAggregate<int, ResourceClass>
 */
#[Kubernetes\Kind('ResourceClassList', group: 'resource.k8s.io', version: 'v1alpha2')]
class ResourceClassList implements IteratorAggregate
{
    #[Kubernetes\Attribute('apiVersion')]
    protected string|null $apiVersion = 'resource.k8s.io/v1alpha2';

    /** @var iterable|ResourceClass[] */
    #[Kubernetes\Attribute('items', type: AttributeType::Collection, model: ResourceClass::class, required: true)]
    protected iterable $items;

    #[Kubernetes\Attribute('kind')]
    protected string|null $kind = 'ResourceClassList';

    #[Kubernetes\Attribute('metadata', type: AttributeType::Model, model: ListMeta::class)]
    protected ListMeta|null $metadata = null;

    /** @param iterable|ResourceClass[] $items */
    ...
    /** @return ArrayIterator|iterable|ResourceClass[] */
    ...
    /** @return static */
    public function addItems(ResourceClass $item): static
    {
        if (! $this->items) {
