 ...
 *
 * @implements IteratorAggregate<int, ResourceClaim>
 */
#[Kubernetes\Kind('ResourceClaimList', group: 'resource.k8s.io', version: 'v1alpha2')]
class ResourceClaimList implements IteratorAggregate
{
    #[Kubernetes\Attribute('apiVersion')]
    protected string|null $apiVersion = 'resource.k8s.io/v1alpha2';

    /** @var iterable|ResourceClaim[] */
    #[Kubernetes\Attribute('items', type: AttributeType::Collection, model: ResourceClaim::class, required: true)]
    protected iterable $items;

    #[Kubernetes\Attribute('kind')]
    protected string|null $kind = 'ResourceClaimList';

    #[Kubernetes\Attribute('metadata', type: AttributeType::Model, model: ListMeta::class)]
    protected ListMeta|null $metadata = null;

    /** @param iterable|ResourceClaim[] $items */
    ...
    /** @return ArrayIterator|iterable|ResourceClaim[] */
    ...
    /** @return static */
    public function addItems(ResourceClaim $item): static
    {
        if (! $this->items) {
