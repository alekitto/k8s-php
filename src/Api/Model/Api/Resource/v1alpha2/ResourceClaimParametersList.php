 ...
 *
 * @implements IteratorAggregate<int, ResourceClaimParameters>
 */
#[Kubernetes\Kind('ResourceClaimParametersList', group: 'resource.k8s.io', version: 'v1alpha2')]
class ResourceClaimParametersList implements IteratorAggregate
{
    #[Kubernetes\Attribute('apiVersion')]
    protected string|null $apiVersion = 'resource.k8s.io/v1alpha2';

    /** @var iterable|ResourceClaimParameters[] */
    #[Kubernetes\Attribute('items', type: AttributeType::Collection, model: ResourceClaimParameters::class, required: true)]
    protected iterable $items;

    #[Kubernetes\Attribute('kind')]
    protected string|null $kind = 'ResourceClaimParametersList';

    #[Kubernetes\Attribute('metadata', type: AttributeType::Model, model: ListMeta::class)]
    protected ListMeta|null $metadata = null;

    /** @param iterable|ResourceClaimParameters[] $items */
    ...
    /** @return ArrayIterator|iterable|ResourceClaimParameters[] */
     ...
     *
     * @return iterable|ResourceClaimParameters[]
     */
    ...
    /** @return static */
    public function addItems(ResourceClaimParameters $item): static
    {
        if (! $this->items) {
