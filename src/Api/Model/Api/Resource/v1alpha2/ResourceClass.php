 ...
 */
#[Kubernetes\Kind('ResourceClass', group: 'resource.k8s.io', version: 'v1alpha2')]
#[Kubernetes\Operation('get', path: '/apis/resource.k8s.io/v1alpha2/resourceclasses/{name}', response: 'self')]
#[Kubernetes\Operation('post', path: '/apis/resource.k8s.io/v1alpha2/resourceclasses', body: 'model', response: 'self')]
#[Kubernetes\Operation('delete', path: '/apis/resource.k8s.io/v1alpha2/resourceclasses/{name}', response: 'self')]
#[Kubernetes\Operation('put', path: '/apis/resource.k8s.io/v1alpha2/resourceclasses/{name}', body: 'model', response: 'self')]
...
#[Kubernetes\Operation('patch', path: '/apis/resource.k8s.io/v1alpha2/resourceclasses/{name}', body: 'patch', response: 'self')]
#[Kubernetes\Operation('list-all', path: '/apis/resource.k8s.io/v1alpha2/resourceclasses', response: ResourceClassList::class)]
class ResourceClass
{
    ...
    protected string|null $kind = 'ResourceClass';

    #[Kubernetes\Attribute('metadata', type: AttributeType::Model, model: ObjectMeta::class)]
    protected ObjectMeta|null $metadata = null;

    #[Kubernetes\Attribute('parametersRef', type: AttributeType::Model, model: ResourceClassParametersReference::class)]
    protected ResourceClassParametersReference|null $parametersRef = null;

    #[Kubernetes\Attribute('structuredParameters')]
    protected bool|null $structuredParameters = null;
    ...
    public function __construct(string|null $name, string $driverName)
    {
    ...
    /**
     * DriverName defines the name of the dynamic resource driver that is used for allocation of a
     * ResourceClaim that uses this class.
     *
    ...
    /**
     * ParametersRef references an arbitrary separate object that may hold parameters that will be used by
     * the driver when allocating a resource that uses this class. A dynamic resource driver can
     * distinguish between parameters stored here and and those stored in ResourceClaimSpec.
     */
     ...
     * @return static
     */
    public function setParametersRef(ResourceClassParametersReference $parametersRef): static
    {
    ...
    /**
     * If and only if allocation of claims using this class is handled via structured parameters, then
     * StructuredParameters must be set to true.
     */
    public function isStructuredParameters(): bool|null
    {
     ...
     * @return static
     */
    public function setIsStructuredParameters(bool $structuredParameters): static
    {
     ...
     * fits a Pod when that Pod uses a ResourceClaim that has not been allocated yet.
     *
