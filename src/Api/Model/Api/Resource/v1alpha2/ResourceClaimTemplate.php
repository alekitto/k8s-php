 ...
 */
#[Kubernetes\Kind('ResourceClaimTemplate', group: 'resource.k8s.io', version: 'v1alpha2')]
#[Kubernetes\Operation('get', path: '/apis/resource.k8s.io/v1alpha2/namespaces/{namespace}/resourceclaimtemplates/{name}', response: 'self')]
...
#[Kubernetes\Operation('delete', path: '/apis/resource.k8s.io/v1alpha2/namespaces/{namespace}/resourceclaimtemplates/{name}', response: 'self')]
#[Kubernetes\Operation(
    'watch',
    path: '/apis/resource.k8s.io/v1alpha2/namespaces/{namespace}/resourceclaimtemplates',
...
#[Kubernetes\Operation(
    'list',
    path: '/apis/resource.k8s.io/v1alpha2/namespaces/{namespace}/resourceclaimtemplates',
    response: ResourceClaimTemplateList::class,
)]
#[Kubernetes\Operation('list-all', path: '/apis/resource.k8s.io/v1alpha2/resourceclaimtemplates', response: ResourceClaimTemplateList::class)]
class ResourceClaimTemplate
{
    #[Kubernetes\Attribute('apiVersion')]
    protected string $apiVersion = 'resource.k8s.io/v1alpha2';

    #[Kubernetes\Attribute('kind')]
    protected string $kind = 'ResourceClaimTemplate';

    #[Kubernetes\Attribute('metadata', type: AttributeType::Model, model: ObjectMeta::class)]
    protected ObjectMeta $metadata;

    #[Kubernetes\Attribute('spec', type: AttributeType::Model, model: ResourceClaimTemplateSpec::class, required: true)]
    protected ResourceClaimTemplateSpec $spec;

    public function __construct(string $name, string $resourceClassName)
    {
        $this->metadata = new ObjectMeta($name);
        $this->spec = new ResourceClaimTemplateSpec($name, $resourceClassName);
    }
     ...
     *
     * This field is immutable. A ResourceClaim will get created by the control plane for a Pod when needed
     * and then not get updated anymore.
     */
     ...
     * @return static
     */
    public function setSpec(ResourceClaimTemplateSpec $spec): static
    {
        $this->spec = $spec;
