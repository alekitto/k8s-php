 ...
 */
#[Kubernetes\Kind('ResourceSlice', group: 'resource.k8s.io', version: 'v1alpha2')]
#[Kubernetes\Operation('get', path: '/apis/resource.k8s.io/v1alpha2/resourceslices/{name}', response: 'self')]
#[Kubernetes\Operation('post', path: '/apis/resource.k8s.io/v1alpha2/resourceslices', body: 'model', response: 'self')]
#[Kubernetes\Operation('delete', path: '/apis/resource.k8s.io/v1alpha2/resourceslices/{name}', response: 'self')]
#[Kubernetes\Operation('put', path: '/apis/resource.k8s.io/v1alpha2/resourceslices/{name}', body: 'model', response: 'self')]
...
class ResourceSlice
{
    ...
    protected string|null $kind = 'ResourceSlice';

    #[Kubernetes\Attribute('metadata', type: AttributeType::Model, model: ObjectMeta::class)]
    protected ObjectMeta|null $metadata = null;

    #[Kubernetes\Attribute('namedResources', type: AttributeType::Model, model: NamedResourcesResources::class)]
    protected NamedResourcesResources|null $namedResources = null;
    ...
    /**
     * DriverName identifies the DRA driver providing the capacity information. A field selector can be
     * used to list only ResourceSlice objects with a certain driver name.
     */
     ...
     */
    public function getNamedResources(): NamedResourcesResources|null
    {
     ...
     * @return static
     */
    public function setNamedResources(NamedResourcesResources $namedResources): static
    {
