 ...
 */
#[Kubernetes\Kind('PodSchedulingContext', group: 'resource.k8s.io', version: 'v1alpha2')]
#[Kubernetes\Operation('get', path: '/apis/resource.k8s.io/v1alpha2/namespaces/{namespace}/podschedulingcontexts/{name}', response: 'self')]
...
#[Kubernetes\Operation('delete', path: '/apis/resource.k8s.io/v1alpha2/namespaces/{namespace}/podschedulingcontexts/{name}', response: 'self')]
#[Kubernetes\Operation(
    'watch',
    path: '/apis/resource.k8s.io/v1alpha2/namespaces/{namespace}/podschedulingcontexts',
...
#[Kubernetes\Operation('list-all', path: '/apis/resource.k8s.io/v1alpha2/podschedulingcontexts', response: PodSchedulingContextList::class)]
