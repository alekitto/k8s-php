 ...
 *
 * @implements IteratorAggregate<int, ResourceClassParameters>
 */
#[Kubernetes\Kind('ResourceClassParametersList', group: 'resource.k8s.io', version: 'v1alpha2')]
class ResourceClassParametersList implements IteratorAggregate
{
    #[Kubernetes\Attribute('apiVersion')]
    protected string|null $apiVersion = 'resource.k8s.io/v1alpha2';

    /** @var iterable|ResourceClassParameters[] */
    #[Kubernetes\Attribute('items', type: AttributeType::Collection, model: ResourceClassParameters::class, required: true)]
    protected iterable $items;

    #[Kubernetes\Attribute('kind')]
    protected string|null $kind = 'ResourceClassParametersList';

    #[Kubernetes\Attribute('metadata', type: AttributeType::Model, model: ListMeta::class)]
    protected ListMeta|null $metadata = null;

    /** @param iterable|ResourceClassParameters[] $items */
    ...
    /** @return ArrayIterator|iterable|ResourceClassParameters[] */
     ...
     *
     * @return iterable|ResourceClassParameters[]
     */
    ...
    /** @return static */
    public function addItems(ResourceClassParameters $item): static
    {
        if (! $this->items) {
