 ...
 * example, if a workload needs an accelerator device with specific properties, this is how that
 * request is expressed. The status stanza tracks whether this claim has been satisfied and what
 * specific resources have been allocated.
 *
 * This is an alpha type and requires enabling the DynamicResourceAllocation feature gate.
 */
#[Kubernetes\Kind('ResourceClaim', group: 'resource.k8s.io', version: 'v1alpha3')]
#[Kubernetes\Operation('get', path: '/apis/resource.k8s.io/v1alpha3/namespaces/{namespace}/resourceclaims/{name}', response: 'self')]
#[Kubernetes\Operation(
    'get-status',
    path: '/apis/resource.k8s.io/v1alpha3/namespaces/{namespace}/resourceclaims/{name}/status',
    response: 'self',
)]
#[Kubernetes\Operation('post', path: '/apis/resource.k8s.io/v1alpha3/namespaces/{namespace}/resourceclaims', body: 'model', response: 'self')]
#[Kubernetes\Operation('delete', path: '/apis/resource.k8s.io/v1alpha3/namespaces/{namespace}/resourceclaims/{name}')]
#[Kubernetes\Operation(
    'watch',
...
#[Kubernetes\Operation('list', path: '/apis/resource.k8s.io/v1alpha3/namespaces/{namespace}/resourceclaims', response: ResourceClaimList::class)]
#[Kubernetes\Operation('list-all', path: '/apis/resource.k8s.io/v1alpha3/resourceclaims', response: ResourceClaimList::class)]
class ResourceClaim
{
    ...
    protected string $kind = 'ResourceClaim';

    #[Kubernetes\Attribute('metadata', type: AttributeType::Model, model: ObjectMeta::class)]
    protected ObjectMeta $metadata;

    #[Kubernetes\Attribute('spec', type: AttributeType::Model, model: ResourceClaimSpec::class, required: true)]
    protected ResourceClaimSpec $spec;

    #[Kubernetes\Attribute('status', type: AttributeType::Model, model: ResourceClaimStatus::class)]
    protected ResourceClaimStatus|null $status = null;

    public function __construct(string|null $name, ResourceClaimSpec $spec)
    {
     ...
     * @return static
     */
    public function setSpec(ResourceClaimSpec $spec): static
    {
        $this->spec = $spec;
     ...
     */
    public function getStatus(): ResourceClaimStatus|null
    {
        return $this->status;
    }
     ...
     * @return static
     */
    public function setStatus(ResourceClaimStatus $status): static
    {
        $this->status = $status;
