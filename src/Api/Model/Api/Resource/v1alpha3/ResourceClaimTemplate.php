 ...
 */
#[Kubernetes\Kind('ResourceClaimTemplate', group: 'resource.k8s.io', version: 'v1alpha3')]
#[Kubernetes\Operation('get', path: '/apis/resource.k8s.io/v1alpha3/namespaces/{namespace}/resourceclaimtemplates/{name}', response: 'self')]
...
#[Kubernetes\Operation('delete', path: '/apis/resource.k8s.io/v1alpha3/namespaces/{namespace}/resourceclaimtemplates/{name}')]
#[Kubernetes\Operation(
    'watch',
    path: '/apis/resource.k8s.io/v1alpha3/namespaces/{namespace}/resourceclaimtemplates',
...
#[Kubernetes\Operation('list-all', path: '/apis/resource.k8s.io/v1alpha3/resourceclaimtemplates', response: ResourceClaimTemplateList::class)]
