...
/**
 * DeviceClass is a vendor- or admin-provided resource that contains device configuration and
 * selectors. It can be referenced in the device requests of a claim to apply these presets. Cluster
 * scoped.
 *
 * This is an alpha type and requires enabling the DynamicResourceAllocation feature gate.
 */
#[Kubernetes\Kind('DeviceClass', group: 'resource.k8s.io', version: 'v1alpha3')]
#[Kubernetes\Operation('get', path: '/apis/resource.k8s.io/v1alpha3/deviceclasses/{name}', response: 'self')]
#[Kubernetes\Operation('post', path: '/apis/resource.k8s.io/v1alpha3/deviceclasses', body: 'model', response: 'self')]
#[Kubernetes\Operation('delete', path: '/apis/resource.k8s.io/v1alpha3/deviceclasses/{name}')]
#[Kubernetes\Operation('put', path: '/apis/resource.k8s.io/v1alpha3/deviceclasses/{name}', body: 'model', response: 'self')]
...
#[Kubernetes\Operation('patch', path: '/apis/resource.k8s.io/v1alpha3/deviceclasses/{name}', body: 'patch', response: 'self')]
#[Kubernetes\Operation('list-all', path: '/apis/resource.k8s.io/v1alpha3/deviceclasses', response: DeviceClassList::class)]
class DeviceClass
{
    ...
    protected string $kind = 'DeviceClass';

    #[Kubernetes\Attribute('metadata', type: AttributeType::Model, model: ObjectMeta::class)]
    protected ObjectMeta $metadata;

    #[Kubernetes\Attribute('spec', type: AttributeType::Model, model: DeviceClassSpec::class, required: true)]
    protected DeviceClassSpec $spec;

    public function __construct(string|null $name, DeviceClassSpec $spec)
    {
    ...
    {
        $this->spec->setSelectors($selectors);
    ...
    {
        $this->spec->addSelectors($selector);
    ...
    {
        return $this->spec->getSuitableNodes();
    }
    ...
    {
        $this->spec->setSuitableNodes($suitableNodes);
     ...
     *
     * This is mutable. Consumers have to be prepared for classes changing at any time, either because they
     * get updated or replaced. Claim allocations are done once based on whatever was set in classes at the
     * time of allocation.
     *
     * Changing the spec automatically increments the metadata.generation number.
     */
    public function getSpec(): DeviceClassSpec
    {
        return $this->spec;
    }
     ...
     * @return static
     */
    public function setSpec(DeviceClassSpec $spec): static
    {
        $this->spec = $spec;
