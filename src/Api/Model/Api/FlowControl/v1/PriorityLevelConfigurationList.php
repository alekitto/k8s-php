 ...
 */
#[Kubernetes\Kind('PriorityLevelConfigurationList', group: 'flowcontrol.apiserver.k8s.io', version: 'v1')]
class PriorityLevelConfigurationList implements IteratorAggregate
{
    #[Kubernetes\Attribute('apiVersion')]
    protected string|null $apiVersion = 'flowcontrol.apiserver.k8s.io/v1';
