...
class QueuingConfiguration
{
    ...
    protected int|null $handSize = null;

    #[Kubernetes\Attribute('queueLengthLimit')]
    protected int|null $queueLengthLimit = null;

    #[Kubernetes\Attribute('queues')]
    protected int|null $queues = null;

    public function __construct(int|null $handSize = null, int|null $queueLengthLimit = null, int|null $queues = null)
    {
     ...
     * @return static
     */
    public function setHandSize(int $handSize): static
    {
        $this->handSize = $handSize;
     ...
     * @return static
     */
    public function setQueueLengthLimit(int $queueLengthLimit): static
    {
        $this->queueLengthLimit = $queueLengthLimit;
     ...
     * @return static
     */
    public function setQueues(int $queues): static
    {
        $this->queues = $queues;
