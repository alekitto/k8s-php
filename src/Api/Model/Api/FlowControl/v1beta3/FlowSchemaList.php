 ...
 */
#[Kubernetes\Kind('FlowSchemaList', group: 'flowcontrol.apiserver.k8s.io', version: 'v1beta3')]
class FlowSchemaList implements IteratorAggregate
{
    ...
    #[Kubernetes\Attribute('items', type: AttributeType::Collection, model: FlowSchema::class, required: true)]
    protected iterable $items;

    #[Kubernetes\Attribute('kind')]
    protected string|null $kind = 'FlowSchemaList';
    ...
    /** @return static */
    public function addItems(FlowSchema $item): static
    {
        if (! $this->items) {
