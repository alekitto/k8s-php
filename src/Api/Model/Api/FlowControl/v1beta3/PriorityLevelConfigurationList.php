 ...
 */
#[Kubernetes\Kind('PriorityLevelConfigurationList', group: 'flowcontrol.apiserver.k8s.io', version: 'v1beta3')]
class PriorityLevelConfigurationList implements IteratorAggregate
{
    #[Kubernetes\Attribute('apiVersion')]
    protected string|null $apiVersion = 'flowcontrol.apiserver.k8s.io/v1beta3';

    /** @var iterable|PriorityLevelConfiguration[] */
    #[Kubernetes\Attribute('items', type: AttributeType::Collection, model: PriorityLevelConfiguration::class, required: true)]
    protected iterable $items;

    #[Kubernetes\Attribute('kind')]
    protected string|null $kind = 'PriorityLevelConfigurationList';
    ...
    /** @return static */
    public function addItems(PriorityLevelConfiguration $item): static
    {
        if (! $this->items) {
