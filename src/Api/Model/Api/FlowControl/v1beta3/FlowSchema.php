 ...
 */
#[Kubernetes\Kind('FlowSchema', group: 'flowcontrol.apiserver.k8s.io', version: 'v1beta3')]
...
#[Kubernetes\Operation('patch', path: '/apis/flowcontrol.apiserver.k8s.io/v1beta3/flowschemas/{name}', body: 'patch', response: 'self')]
#[Kubernetes\Operation(
    'patch-status',
    path: '/apis/flowcontrol.apiserver.k8s.io/v1beta3/flowschemas/{name}/status',
    body: 'patch',
...
#[Kubernetes\Operation('list-all', path: '/apis/flowcontrol.apiserver.k8s.io/v1beta3/flowschemas', response: FlowSchemaList::class)]
class FlowSchema
{
