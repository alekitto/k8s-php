...
class ReplicaSetList implements IteratorAggregate
{
    ...
    #[Kubernetes\Attribute('items', type: AttributeType::Collection, model: ReplicaSet::class, required: true)]
    protected iterable $items;

    #[Kubernetes\Attribute('kind')]
    protected string|null $kind = 'ReplicaSetList';
    ...
    /** @return static */
    public function addItems(ReplicaSet $item): static
    {
        if (! $this->items) {
