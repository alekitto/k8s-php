...
class ControllerRevisionList implements IteratorAggregate
{
    ...
    protected string|null $apiVersion = 'apps/v1';

    /** @var iterable|ControllerRevision[] */
    #[Kubernetes\Attribute('items', type: AttributeType::Collection, model: ControllerRevision::class, required: true)]
    protected iterable $items;

    #[Kubernetes\Attribute('kind')]
    protected string|null $kind = 'ControllerRevisionList';
    ...
    /** @return static */
    public function addItems(ControllerRevision $item): static
    {
        if (! $this->items) {
