...
class RollingUpdateDaemonSet
{
    ...
    protected int|string|null $maxSurge = null;

    #[Kubernetes\Attribute('maxUnavailable')]
    protected int|string|null $maxUnavailable = null;

    public function __construct(int|string|null $maxSurge = null, int|string|null $maxUnavailable = null)
    {
     ...
     */
    public function getMaxSurge(): int|string
    {
     ...
     * @return static
     */
    public function setMaxSurge(int|string $maxSurge): static
    {
        $this->maxSurge = $maxSurge;
