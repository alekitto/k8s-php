...
class DeploymentList implements IteratorAggregate
{
    ...
    #[Kubernetes\Attribute('items', type: AttributeType::Collection, model: Deployment::class, required: true)]
    protected iterable $items;

    #[Kubernetes\Attribute('kind')]
    protected string|null $kind = 'DeploymentList';
    ...
    /** @return static */
    public function addItems(Deployment $item): static
    {
        if (! $this->items) {
