...
class DaemonSetList implements IteratorAggregate
{
    ...
    #[Kubernetes\Attribute('items', type: AttributeType::Collection, model: DaemonSet::class, required: true)]
    protected iterable $items;

    #[Kubernetes\Attribute('kind')]
    protected string|null $kind = 'DaemonSetList';
    ...
    /** @return static */
    public function addItems(DaemonSet $item): static
    {
        if (! $this->items) {
