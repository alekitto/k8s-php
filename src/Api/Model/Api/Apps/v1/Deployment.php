...
#[Kubernetes\Operation('get', path: '/apis/apps/v1/namespaces/{namespace}/deployments/{name}', response: 'self')]
#[Kubernetes\Operation('get-status', path: '/apis/apps/v1/namespaces/{namespace}/deployments/{name}/status', response: 'self')]
#[Kubernetes\Operation('post', path: '/apis/apps/v1/namespaces/{namespace}/deployments', body: 'model', response: 'self')]
#[Kubernetes\Operation('delete', path: '/apis/apps/v1/namespaces/{namespace}/deployments/{name}')]
...
class Deployment
{
    ...
    #[Kubernetes\Attribute('spec', type: AttributeType::Model, model: DeploymentSpec::class)]
    protected DeploymentSpec $spec;

    #[Kubernetes\Attribute('status', type: AttributeType::Model, model: DeploymentStatus::class)]
    protected DeploymentStatus|null $status = null;

    public function __construct(string|null $name, LabelSelector $selector, PodTemplateSpec $template)
    {
     ...
     * @return static
     */
    public function setSpec(DeploymentSpec $spec): static
    {
        $this->spec = $spec;
     ...
     */
    public function getStatus(): DeploymentStatus|null
    {
        return $this->status;
    }
