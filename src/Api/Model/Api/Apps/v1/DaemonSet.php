...
class DaemonSet
{
    ...
    #[Kubernetes\Attribute('spec', type: AttributeType::Model, model: DaemonSetSpec::class)]
    protected DaemonSetSpec $spec;

    #[Kubernetes\Attribute('status', type: AttributeType::Model, model: DaemonSetStatus::class)]
    protected DaemonSetStatus|null $status = null;
     ...
     * @return static
     */
    public function setSpec(DaemonSetSpec $spec): static
    {
        $this->spec = $spec;
     ...
     * https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
     */
    public function getStatus(): DaemonSetStatus|null
    {
        return $this->status;
    }
}
