...
class PodDisruptionBudget
{
    ...
    protected string $apiVersion = 'policy/v1';

    #[Kubernetes\Attribute('kind')]
    protected string $kind = 'PodDisruptionBudget';

    #[Kubernetes\Attribute('metadata', type: AttributeType::Model, model: ObjectMeta::class)]
    protected ObjectMeta $metadata;

    #[Kubernetes\Attribute('spec', type: AttributeType::Model, model: PodDisruptionBudgetSpec::class)]
    protected PodDisruptionBudgetSpec $spec;

    #[Kubernetes\Attribute('status', type: AttributeType::Model, model: PodDisruptionBudgetStatus::class)]
    protected PodDisruptionBudgetStatus|null $status = null;
    ...
    {
        return $this->spec->getUnhealthyPodEvictionPolicy();
    }
    ...
    {
        $this->spec->setUnhealthyPodEvictionPolicy($unhealthyPodEvictionPolicy);
     ...
     * @return static
     */
    public function setSpec(PodDisruptionBudgetSpec $spec): static
    {
        $this->spec = $spec;
     ...
     */
    public function getStatus(): PodDisruptionBudgetStatus|null
    {
        return $this->status;
    }
     ...
     * @return static
     */
    public function setStatus(PodDisruptionBudgetStatus $status): static
    {
        $this->status = $status;
