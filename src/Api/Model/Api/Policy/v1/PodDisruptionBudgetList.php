...
class PodDisruptionBudgetList implements IteratorAggregate
{
    ...
    #[Kubernetes\Attribute('items', type: AttributeType::Collection, model: PodDisruptionBudget::class, required: true)]
    protected iterable $items;

    #[Kubernetes\Attribute('kind')]
    protected string|null $kind = 'PodDisruptionBudgetList';
    ...
    /** @return static */
    public function addItems(PodDisruptionBudget $item): static
    {
        if (! $this->items) {
