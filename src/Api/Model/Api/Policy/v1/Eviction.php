...
use Kcs\K8s\Api\Model\ApiMachinery\Apis\Meta\v1\DeleteOptions;
...
#[Kubernetes\Operation('post', path: '/api/v1/namespaces/{namespace}/pods/{name}/eviction', body: 'model', response: 'self')]
class Eviction
{
    #[Kubernetes\Attribute('apiVersion')]
    protected string|null $apiVersion = 'policy/v1';

    #[Kubernetes\Attribute('deleteOptions', type: AttributeType::Model, model: DeleteOptions::class)]
    protected DeleteOptions|null $deleteOptions = null;

    #[Kubernetes\Attribute('kind')]
    protected string|null $kind = 'Eviction';
     ...
     */
    public function getDeleteOptions(): DeleteOptions|null
    {
     ...
     * @return static
     */
    public function setDeleteOptions(DeleteOptions $deleteOptions): static
    {
