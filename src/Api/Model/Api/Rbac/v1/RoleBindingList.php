...
class RoleBindingList implements IteratorAggregate
{
    ...
    #[Kubernetes\Attribute('items', type: AttributeType::Collection, model: RoleBinding::class, required: true)]
    protected iterable $items;

    #[Kubernetes\Attribute('kind')]
    protected string|null $kind = 'RoleBindingList';
    ...
    /** @return static */
    public function addItems(RoleBinding $item): static
    {
        if (! $this->items) {
