...
class ClusterRoleBindingList implements IteratorAggregate
{
    ...
    #[Kubernetes\Attribute('items', type: AttributeType::Collection, model: ClusterRoleBinding::class, required: true)]
    protected iterable $items;

    #[Kubernetes\Attribute('kind')]
    protected string|null $kind = 'ClusterRoleBindingList';
    ...
    /** @return static */
    public function addItems(ClusterRoleBinding $item): static
    {
        if (! $this->items) {
