...
#[Kubernetes\Operation('get', path: '/apis/rbac.authorization.k8s.io/v1/clusterroles/{name}', response: 'self')]
#[Kubernetes\Operation('post', path: '/apis/rbac.authorization.k8s.io/v1/clusterroles', body: 'model', response: 'self')]
#[Kubernetes\Operation('delete', path: '/apis/rbac.authorization.k8s.io/v1/clusterroles/{name}')]
...
class ClusterRole
{
    ...
    protected AggregationRule|null $aggregationRule = null;

    #[Kubernetes\Attribute('apiVersion')]
    protected string|null $apiVersion = 'rbac.authorization.k8s.io/v1';

    #[Kubernetes\Attribute('kind')]
    protected string|null $kind = 'ClusterRole';
    ...
    #[Kubernetes\Attribute('rules', type: AttributeType::Collection, model: PolicyRule::class)]
     ...
     */
    public function getAggregationRule(): AggregationRule|null
    {
     ...
     * @return static
     */
    public function setAggregationRule(AggregationRule $aggregationRule): static
    {
    ...
    /** @return static */
    public function addRules(PolicyRule $rule): static
    {
        if (! $this->rules) {
