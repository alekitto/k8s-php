...
class ClusterRoleList implements IteratorAggregate
{
    ...
    #[Kubernetes\Attribute('items', type: AttributeType::Collection, model: ClusterRole::class, required: true)]
    protected iterable $items;

    #[Kubernetes\Attribute('kind')]
    protected string|null $kind = 'ClusterRoleList';
    ...
    /** @return static */
    public function addItems(ClusterRole $item): static
    {
        if (! $this->items) {
