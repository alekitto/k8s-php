...
class RoleList implements IteratorAggregate
{
    ...
    /** @var iterable|Role[] */
    #[Kubernetes\Attribute('items', type: AttributeType::Collection, model: Role::class, required: true)]
    protected iterable $items;

    #[Kubernetes\Attribute('kind')]
    protected string|null $kind = 'RoleList';
    ...
    /** @return static */
    public function addItems(Role $item): static
    {
        if (! $this->items) {
