...
class SecretList implements IteratorAggregate
{
    ...
    /** @var iterable|Secret[] */
    #[Kubernetes\Attribute('items', type: AttributeType::Collection, model: Secret::class, required: true)]
    protected iterable $items;

    #[Kubernetes\Attribute('kind')]
    protected string|null $kind = 'SecretList';
    ...
    /** @return static */
    public function addItems(Secret $item): static
    {
        if (! $this->items) {
