...
#[Kubernetes\Operation('delete', path: '/api/v1/namespaces/{namespace}/limitranges/{name}')]
...
#[Kubernetes\Operation('watch-all', path: '/api/v1/limitranges', response: WatchEvent::class)]
#[Kubernetes\Operation('patch', path: '/api/v1/namespaces/{namespace}/limitranges/{name}', body: 'patch', response: 'self')]
#[Kubernetes\Operation('list', path: '/api/v1/namespaces/{namespace}/limitranges', response: LimitRangeList::class)]
#[Kubernetes\Operation('list-all', path: '/api/v1/limitranges', response: LimitRangeList::class)]
class LimitRange
{
