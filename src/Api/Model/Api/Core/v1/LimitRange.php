...
#[Kubernetes\Operation('get', path: '/api/v1/namespaces/{namespace}/limitranges/{name}', response: 'self')]
#[Kubernetes\Operation('post', path: '/api/v1/namespaces/{namespace}/limitranges', body: 'model', response: 'self')]
...
#[Kubernetes\Operation('put', path: '/api/v1/namespaces/{namespace}/limitranges/{name}', body: 'model', response: 'self')]
#[Kubernetes\Operation(
    'deletecollection-all',
    path: '/api/v1/namespaces/{namespace}/limitranges',
    response: 'Kcs\K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status',
)]
#[Kubernetes\Operation('watch-all', path: '/api/v1/limitranges', response: 'Kcs\K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent')]
#[Kubernetes\Operation('patch', path: '/api/v1/namespaces/{namespace}/limitranges/{name}', body: 'patch', response: 'self')]
#[Kubernetes\Operation('list', path: '/api/v1/namespaces/{namespace}/limitranges', response: 'Kcs\K8s\Api\Model\Api\Core\v1\LimitRangeList')]
#[Kubernetes\Operation('list-all', path: '/api/v1/limitranges', response: 'Kcs\K8s\Api\Model\Api\Core\v1\LimitRangeList')]
class LimitRange
{
    ...
    #[Kubernetes\Attribute('spec', type: AttributeType::Model, model: LimitRangeSpec::class)]
    protected LimitRangeSpec $spec;

    /** @param iterable|LimitRangeItem[] $limits */
    public function __construct(string|null $name, iterable $limits)
    {
     ...
     * @return static
     */
    public function setSpec(LimitRangeSpec $spec): static
    {
        $this->spec = $spec;
