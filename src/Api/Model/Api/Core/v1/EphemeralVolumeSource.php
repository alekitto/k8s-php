...
{
    #[Kubernetes\Attribute('volumeClaimTemplate', type: AttributeType::Model, model: PersistentVolumeClaimTemplate::class)]
    protected PersistentVolumeClaimTemplate|null $volumeClaimTemplate = null;

    public function __construct(PersistentVolumeClaimTemplate|null $volumeClaimTemplate = null)
    {
     ...
     */
    public function getVolumeClaimTemplate(): PersistentVolumeClaimTemplate|null
    {
     ...
     * @return static
     */
    public function setVolumeClaimTemplate(PersistentVolumeClaimTemplate $volumeClaimTemplate): static
    {
        $this->volumeClaimTemplate = $volumeClaimTemplate;
