...
#[Kubernetes\Operation('get', path: '/api/v1/namespaces/{namespace}/replicationcontrollers/{name}', response: 'self')]
#[Kubernetes\Operation('get-status', path: '/api/v1/namespaces/{namespace}/replicationcontrollers/{name}/status', response: 'self')]
#[Kubernetes\Operation('post', path: '/api/v1/namespaces/{namespace}/replicationcontrollers', body: 'model', response: 'self')]
#[Kubernetes\Operation('delete', path: '/api/v1/namespaces/{namespace}/replicationcontrollers/{name}')]
...
class ReplicationController
{
    ...
    #[Kubernetes\Attribute('spec', type: AttributeType::Model, model: ReplicationControllerSpec::class)]
    protected ReplicationControllerSpec $spec;

    #[Kubernetes\Attribute('status', type: AttributeType::Model, model: ReplicationControllerStatus::class)]
    protected ReplicationControllerStatus|null $status = null;
     ...
     * @return static
     */
    public function setSpec(ReplicationControllerSpec $spec): static
    {
        $this->spec = $spec;
     ...
     * https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
     */
    public function getStatus(): ReplicationControllerStatus|null
    {
        return $this->status;
    }
}
