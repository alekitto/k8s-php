...
class PersistentVolumeClaimList implements IteratorAggregate
{
    ...
    #[Kubernetes\Attribute('items', type: AttributeType::Collection, model: PersistentVolumeClaim::class, required: true)]
    protected iterable $items;

    #[Kubernetes\Attribute('kind')]
    protected string|null $kind = 'PersistentVolumeClaimList';
    ...
    /** @return static */
    public function addItems(PersistentVolumeClaim $item): static
    {
        if (! $this->items) {
