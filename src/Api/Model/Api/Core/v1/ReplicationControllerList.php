...
class ReplicationControllerList implements IteratorAggregate
{
    ...
    #[Kubernetes\Attribute('items', type: AttributeType::Collection, model: ReplicationController::class, required: true)]
    protected iterable $items;

    #[Kubernetes\Attribute('kind')]
    protected string|null $kind = 'ReplicationControllerList';
    ...
    /** @return static */
    public function addItems(ReplicationController $item): static
    {
        if (! $this->items) {
