...
class PersistentVolumeClaimTemplate
{
    ...
    #[Kubernetes\Attribute('spec', type: AttributeType::Model, model: PersistentVolumeClaimSpec::class, required: true)]
    protected PersistentVolumeClaimSpec $spec;

    public function __construct(string|null $name, PersistentVolumeClaimSpec $spec)
    {
