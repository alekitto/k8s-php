...
class ResourceQuotaList implements IteratorAggregate
{
    ...
    #[Kubernetes\Attribute('items', type: AttributeType::Collection, model: ResourceQuota::class, required: true)]
    protected iterable $items;

    #[Kubernetes\Attribute('kind')]
    protected string|null $kind = 'ResourceQuotaList';
    ...
    /** @return static */
    public function addItems(ResourceQuota $item): static
    {
        if (! $this->items) {
