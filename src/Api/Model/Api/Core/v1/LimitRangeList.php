...
class LimitRangeList implements IteratorAggregate
{
    ...
    #[Kubernetes\Attribute('items', type: AttributeType::Collection, model: LimitRange::class, required: true)]
    protected iterable $items;

    #[Kubernetes\Attribute('kind')]
    protected string|null $kind = 'LimitRangeList';
    ...
    /** @return static */
    public function addItems(LimitRange $item): static
    {
        if (! $this->items) {
