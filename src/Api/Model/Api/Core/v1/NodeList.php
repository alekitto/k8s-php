...
class NodeList implements IteratorAggregate
{
    ...
    /** @var iterable|Node[] */
    #[Kubernetes\Attribute('items', type: AttributeType::Collection, model: Node::class, required: true)]
    protected iterable $items;

    #[Kubernetes\Attribute('kind')]
    protected string|null $kind = 'NodeList';
    ...
    /** @return static */
    public function addItems(Node $item): static
    {
        if (! $this->items) {
