...
class NamespaceList implements IteratorAggregate
{
    ...
    #[Kubernetes\Attribute('items', type: AttributeType::Collection, model: K8sNamespace::class, required: true)]
    protected iterable $items;

    #[Kubernetes\Attribute('kind')]
    protected string|null $kind = 'NamespaceList';
    ...
    /** @return static */
    public function addItems(K8sNamespace $item): static
    {
        if (! $this->items) {
