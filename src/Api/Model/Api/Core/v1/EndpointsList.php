...
class EndpointsList implements IteratorAggregate
{
    ...
    #[Kubernetes\Attribute('items', type: AttributeType::Collection, model: Endpoints::class, required: true)]
    protected iterable $items;

    #[Kubernetes\Attribute('kind')]
    protected string|null $kind = 'EndpointsList';
    ...
    /** @return static */
    public function addItems(Endpoints $item): static
    {
        if (! $this->items) {
