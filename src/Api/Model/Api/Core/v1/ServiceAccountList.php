...
class ServiceAccountList implements IteratorAggregate
{
    ...
    #[Kubernetes\Attribute('items', type: AttributeType::Collection, model: ServiceAccount::class, required: true)]
    protected iterable $items;

    #[Kubernetes\Attribute('kind')]
    protected string|null $kind = 'ServiceAccountList';
    ...
    /** @return static */
    public function addItems(ServiceAccount $item): static
    {
        if (! $this->items) {
