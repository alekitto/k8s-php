...
class PodTemplateList implements IteratorAggregate
{
    ...
    #[Kubernetes\Attribute('items', type: AttributeType::Collection, model: PodTemplate::class, required: true)]
    protected iterable $items;

    #[Kubernetes\Attribute('kind')]
    protected string|null $kind = 'PodTemplateList';
    ...
    /** @return static */
    public function addItems(PodTemplate $item): static
    {
        if (! $this->items) {
