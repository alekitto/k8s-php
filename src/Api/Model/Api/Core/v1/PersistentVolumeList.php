...
class PersistentVolumeList implements IteratorAggregate
{
    ...
    #[Kubernetes\Attribute('items', type: AttributeType::Collection, model: PersistentVolume::class, required: true)]
    protected iterable $items;

    #[Kubernetes\Attribute('kind')]
    protected string|null $kind = 'PersistentVolumeList';
    ...
    /** @return static */
    public function addItems(PersistentVolume $item): static
    {
        if (! $this->items) {
