...
#[Kubernetes\Operation('watch-all', path: '/api/v1/secrets', response: WatchEvent::class)]
#[Kubernetes\Operation('patch', path: '/api/v1/namespaces/{namespace}/secrets/{name}', body: 'patch', response: 'self')]
#[Kubernetes\Operation('list', path: '/api/v1/namespaces/{namespace}/secrets', response: SecretList::class)]
#[Kubernetes\Operation('list-all', path: '/api/v1/secrets', response: SecretList::class)]
class Secret
{
