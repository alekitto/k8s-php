...
#[Kubernetes\Operation('watch-all', path: '/api/v1/secrets', response: 'Kcs\K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent')]
#[Kubernetes\Operation('patch', path: '/api/v1/namespaces/{namespace}/secrets/{name}', body: 'patch', response: 'self')]
#[Kubernetes\Operation('list', path: '/api/v1/namespaces/{namespace}/secrets', response: 'Kcs\K8s\Api\Model\Api\Core\v1\SecretList')]
#[Kubernetes\Operation('list-all', path: '/api/v1/secrets', response: 'Kcs\K8s\Api\Model\Api\Core\v1\SecretList')]
class Secret
{
    ...
    protected string|null $kind = 'Secret';
    ...
    protected array|null $stringData = null;
     ...
     */
    public function getStringData(): array|null
    {
     ...
     * @return static
     */
    public function setStringData(array $stringData): static
    {
