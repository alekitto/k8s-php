...
class ConfigMapList implements IteratorAggregate
{
    ...
    #[Kubernetes\Attribute('items', type: AttributeType::Collection, model: ConfigMap::class, required: true)]
    protected iterable $items;

    #[Kubernetes\Attribute('kind')]
    protected string|null $kind = 'ConfigMapList';
    ...
    /** @return static */
    public function addItems(ConfigMap $item): static
    {
        if (! $this->items) {
