...
class ServiceList implements IteratorAggregate
{
    ...
    #[Kubernetes\Attribute('items', type: AttributeType::Collection, model: Service::class, required: true)]
    protected iterable $items;

    #[Kubernetes\Attribute('kind')]
    protected string|null $kind = 'ServiceList';
    ...
    /** @return static */
    public function addItems(Service $item): static
    {
        if (! $this->items) {
