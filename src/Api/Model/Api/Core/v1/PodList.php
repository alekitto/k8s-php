...
class PodList implements IteratorAggregate
{
    ...
    /** @var iterable|Pod[] */
    #[Kubernetes\Attribute('items', type: AttributeType::Collection, model: Pod::class, required: true)]
    protected iterable $items;

    #[Kubernetes\Attribute('kind')]
    protected string|null $kind = 'PodList';
    ...
    /** @return static */
    public function addItems(Pod $item): static
    {
        if (! $this->items) {
