...
#[Kubernetes\Operation('post', path: '/api/v1/namespaces/{namespace}/bindings', body: 'model', response: 'self')]
class Binding
{
    ...
    protected string|null $kind = 'Binding';

    #[Kubernetes\Attribute('metadata', type: AttributeType::Model, model: ObjectMeta::class)]
    protected ObjectMeta|null $metadata = null;

    #[Kubernetes\Attribute('target', type: AttributeType::Model, model: ObjectReference::class, required: true)]
    protected ObjectReference $target;

    public function __construct(string|null $name, ObjectReference $target)
    {
     ...
     * @return static
     */
    public function setTarget(ObjectReference $target): static
    {
        $this->target = $target;
