...
class ComponentStatusList implements IteratorAggregate
{
    ...
    #[Kubernetes\Attribute('items', type: AttributeType::Collection, model: ComponentStatus::class, required: true)]
    protected iterable $items;

    #[Kubernetes\Attribute('kind')]
    protected string|null $kind = 'ComponentStatusList';
    ...
    /** @return static */
    public function addItems(ComponentStatus $item): static
    {
        if (! $this->items) {
