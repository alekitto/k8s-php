...
#[Kubernetes\Operation('get', path: '/api/v1/namespaces/{namespace}/resourcequotas/{name}', response: 'self')]
#[Kubernetes\Operation('get-status', path: '/api/v1/namespaces/{namespace}/resourcequotas/{name}/status', response: 'self')]
#[Kubernetes\Operation('post', path: '/api/v1/namespaces/{namespace}/resourcequotas', body: 'model', response: 'self')]
#[Kubernetes\Operation('delete', path: '/api/v1/namespaces/{namespace}/resourcequotas/{name}', response: 'self')]
...
#[Kubernetes\Operation('watch-all', path: '/api/v1/resourcequotas', response: 'Kcs\K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent')]
#[Kubernetes\Operation('patch', path: '/api/v1/namespaces/{namespace}/resourcequotas/{name}', body: 'patch', response: 'self')]
#[Kubernetes\Operation('patch-status', path: '/api/v1/namespaces/{namespace}/resourcequotas/{name}/status', body: 'patch', response: 'self')]
#[Kubernetes\Operation(
    'list',
    path: '/api/v1/namespaces/{namespace}/resourcequotas',
    response: 'Kcs\K8s\Api\Model\Api\Core\v1\ResourceQuotaList',
)]
#[Kubernetes\Operation('list-all', path: '/api/v1/resourcequotas', response: 'Kcs\K8s\Api\Model\Api\Core\v1\ResourceQuotaList')]
class ResourceQuota
{
    ...
    #[Kubernetes\Attribute('spec', type: AttributeType::Model, model: ResourceQuotaSpec::class)]
    protected ResourceQuotaSpec $spec;

    #[Kubernetes\Attribute('status', type: AttributeType::Model, model: ResourceQuotaStatus::class)]
    protected ResourceQuotaStatus|null $status = null;
     ...
     * @return static
     */
    public function setSpec(ResourceQuotaSpec $spec): static
    {
        $this->spec = $spec;
     ...
     * https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
     */
    public function getStatus(): ResourceQuotaStatus|null
    {
        return $this->status;
    }
     ...
     * @return static
     */
    public function setStatus(ResourceQuotaStatus $status): static
    {
        $this->status = $status;
