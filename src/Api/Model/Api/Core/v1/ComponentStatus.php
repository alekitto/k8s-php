...
class ComponentStatus
{
    ...
    #[Kubernetes\Attribute('conditions', type: AttributeType::Collection, model: ComponentCondition::class)]
    protected $conditions = null;

    #[Kubernetes\Attribute('kind')]
    protected string|null $kind = 'ComponentStatus';
    ...
    /** @return static */
    public function addConditions(ComponentCondition $condition): static
    {
        if (! $this->conditions) {
