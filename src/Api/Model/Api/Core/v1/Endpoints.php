...
class Endpoints
{
    ...
    protected string|null $kind = 'Endpoints';
    ...
    #[Kubernetes\Attribute('subsets', type: AttributeType::Collection, model: EndpointSubset::class)]
     ...
     */
    public function getSubsets(): iterable|null
    {
        return $this->subsets;
    }
     ...
     * @return static
     */
    public function setSubsets(iterable $subsets): static
    {
    ...
    /** @return static */
    public function addSubsets(EndpointSubset $subset): static
    {
        if (! $this->subsets) {
