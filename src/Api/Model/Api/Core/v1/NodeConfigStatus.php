...
{
    #[Kubernetes\Attribute('active', type: AttributeType::Model, model: NodeConfigSource::class)]
    protected NodeConfigSource|null $active = null;

    #[Kubernetes\Attribute('assigned', type: AttributeType::Model, model: NodeConfigSource::class)]
    protected NodeConfigSource|null $assigned = null;

    #[Kubernetes\Attribute('error')]
    protected string|null $error = null;

    #[Kubernetes\Attribute('lastKnownGood', type: AttributeType::Model, model: NodeConfigSource::class)]
    protected NodeConfigSource|null $lastKnownGood = null;

    public function __construct(
        NodeConfigSource|null $active = null,
        NodeConfigSource|null $assigned = null,
        string|null $error = null,
        NodeConfigSource|null $lastKnownGood = null,
    ) {
        $this->active = $active;
     ...
     */
    public function getActive(): NodeConfigSource|null
    {
        return $this->active;
    }
     ...
     * @return static
     */
    public function setActive(NodeConfigSource $active): static
    {
        $this->active = $active;
     ...
     */
    public function getAssigned(): NodeConfigSource|null
    {
     ...
     * @return static
     */
    public function setAssigned(NodeConfigSource $assigned): static
    {
        $this->assigned = $assigned;
     ...
     */
    public function getLastKnownGood(): NodeConfigSource|null
    {
     ...
     * @return static
     */
    public function setLastKnownGood(NodeConfigSource $lastKnownGood): static
    {
        $this->lastKnownGood = $lastKnownGood;
