 ...
 */
#[Kubernetes\Kind('SelfSubjectReview', group: 'authentication.k8s.io', version: 'v1alpha1')]
#[Kubernetes\Operation('post', path: '/apis/authentication.k8s.io/v1alpha1/selfsubjectreviews', body: 'model', response: 'self')]
class SelfSubjectReview
{
    #[Kubernetes\Attribute('apiVersion')]
    protected string|null $apiVersion = 'authentication.k8s.io/v1alpha1';
