...
#[Kubernetes\Operation('post', path: '/api/v1/namespaces/{namespace}/serviceaccounts/{name}/token', body: 'model', response: 'self')]
class TokenRequest
{
    #[Kubernetes\Attribute('apiVersion')]
    protected string $apiVersion = 'authentication.k8s.io/v1';

    #[Kubernetes\Attribute('kind')]
    protected string $kind = 'TokenRequest';

    #[Kubernetes\Attribute('metadata', type: AttributeType::Model, model: ObjectMeta::class)]
    protected ObjectMeta $metadata;

    #[Kubernetes\Attribute('spec', type: AttributeType::Model, model: TokenRequestSpec::class, required: true)]
    protected TokenRequestSpec $spec;

    #[Kubernetes\Attribute('status', type: AttributeType::Model, model: TokenRequestStatus::class)]
    protected TokenRequestStatus|null $status = null;

    /** @param string[] $audiences */
    public function __construct(string|null $name, array $audiences)
    {
     ...
     * @return static
     */
    public function setSpec(TokenRequestSpec $spec): static
    {
        $this->spec = $spec;
     ...
     */
    public function getStatus(): TokenRequestStatus|null
    {
        return $this->status;
    }
     ...
     * @return static
     */
    public function setStatus(TokenRequestStatus $status): static
    {
        $this->status = $status;
