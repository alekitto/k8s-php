 ...
 */
#[Kubernetes\Kind('SelfSubjectReview', group: 'authentication.k8s.io', version: 'v1')]
#[Kubernetes\Operation('post', path: '/apis/authentication.k8s.io/v1/selfsubjectreviews', body: 'model', response: 'self')]
class SelfSubjectReview
{
    #[Kubernetes\Attribute('apiVersion')]
    protected string|null $apiVersion = 'authentication.k8s.io/v1';
