...
#[Kubernetes\Operation('get', path: '/apis/internal.apiserver.k8s.io/v1alpha1/storageversions/{name}', response: 'self')]
#[Kubernetes\Operation('get-status', path: '/apis/internal.apiserver.k8s.io/v1alpha1/storageversions/{name}/status', response: 'self')]
#[Kubernetes\Operation('post', path: '/apis/internal.apiserver.k8s.io/v1alpha1/storageversions', body: 'model', response: 'self')]
#[Kubernetes\Operation('delete', path: '/apis/internal.apiserver.k8s.io/v1alpha1/storageversions/{name}')]
#[Kubernetes\Operation('put', path: '/apis/internal.apiserver.k8s.io/v1alpha1/storageversions/{name}', body: 'model', response: 'self')]
...
#[Kubernetes\Operation('patch', path: '/apis/internal.apiserver.k8s.io/v1alpha1/storageversions/{name}', body: 'patch', response: 'self')]
#[Kubernetes\Operation(
    'patch-status',
    path: '/apis/internal.apiserver.k8s.io/v1alpha1/storageversions/{name}/status',
    body: 'patch',
...
#[Kubernetes\Operation('list-all', path: '/apis/internal.apiserver.k8s.io/v1alpha1/storageversions', response: StorageVersionList::class)]
class StorageVersion
{
    #[Kubernetes\Attribute('apiVersion')]
    protected string $apiVersion = 'internal.apiserver.k8s.io/v1alpha1';

    #[Kubernetes\Attribute('kind')]
    protected string $kind = 'StorageVersion';

    #[Kubernetes\Attribute('metadata', type: AttributeType::Model, model: ObjectMeta::class)]
    protected ObjectMeta $metadata;

    #[Kubernetes\Attribute('spec', required: true)]
    protected object $spec;

    #[Kubernetes\Attribute('status', type: AttributeType::Model, model: StorageVersionStatus::class, required: true)]
    protected StorageVersionStatus $status;

    public function __construct(string|null $name, object $spec, StorageVersionStatus $status)
    {
     ...
     * @return static
     */
    public function setSpec(object $spec): static
    {
        $this->spec = $spec;
     ...
     * @return static
     */
    public function setStatus(StorageVersionStatus $status): static
    {
        $this->status = $status;
