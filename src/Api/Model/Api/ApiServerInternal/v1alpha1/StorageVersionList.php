...
class StorageVersionList implements IteratorAggregate
{
    ...
    protected string|null $apiVersion = 'internal.apiserver.k8s.io/v1alpha1';

    /** @var iterable|StorageVersion[] */
    #[Kubernetes\Attribute('items', type: AttributeType::Collection, model: StorageVersion::class, required: true)]
    protected iterable $items;

    #[Kubernetes\Attribute('kind')]
    protected string|null $kind = 'StorageVersionList';
    ...
    /** @return static */
    public function addItems(StorageVersion $item): static
    {
        if (! $this->items) {
