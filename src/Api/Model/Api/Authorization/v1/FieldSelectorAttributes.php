...
use Kcs\K8s\Api\Model\ApiMachinery\Apis\Meta\v1\FieldSelectorRequirement;
...
class FieldSelectorAttributes
{
    ...
    /** @var iterable|FieldSelectorRequirement[]|null */
    #[Kubernetes\Attribute('requirements', type: AttributeType::Collection, model: FieldSelectorRequirement::class)]
    protected $requirements = null;

    /** @param iterable|FieldSelectorRequirement[] $requirements */
    ...
    /**
     * requirements is the parsed interpretation of a field selector. All requirements must be met for a
     ...
     *
     * @return iterable|FieldSelectorRequirement[]
     */
    ...
    /** @return static */
    public function addRequirements(FieldSelectorRequirement $requirement): static
    {
