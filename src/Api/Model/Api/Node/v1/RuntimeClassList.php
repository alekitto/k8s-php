...
class RuntimeClassList implements IteratorAggregate
{
    ...
    #[Kubernetes\Attribute('items', type: AttributeType::Collection, model: RuntimeClass::class, required: true)]
    protected iterable $items;

    #[Kubernetes\Attribute('kind')]
    protected string|null $kind = 'RuntimeClassList';
    ...
    /** @return static */
    public function addItems(RuntimeClass $item): static
    {
        if (! $this->items) {
