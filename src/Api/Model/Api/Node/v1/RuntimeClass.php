...
#[Kubernetes\Operation('get', path: '/apis/node.k8s.io/v1/runtimeclasses/{name}', response: 'self')]
#[Kubernetes\Operation('post', path: '/apis/node.k8s.io/v1/runtimeclasses', body: 'model', response: 'self')]
#[Kubernetes\Operation('delete', path: '/apis/node.k8s.io/v1/runtimeclasses/{name}')]
#[Kubernetes\Operation('put', path: '/apis/node.k8s.io/v1/runtimeclasses/{name}', body: 'model', response: 'self')]
...
#[Kubernetes\Operation('patch', path: '/apis/node.k8s.io/v1/runtimeclasses/{name}', body: 'patch', response: 'self')]
#[Kubernetes\Operation('list-all', path: '/apis/node.k8s.io/v1/runtimeclasses', response: RuntimeClassList::class)]
class RuntimeClass
{
    #[Kubernetes\Attribute('apiVersion')]
    protected string|null $apiVersion = 'node.k8s.io/v1';

    #[Kubernetes\Attribute('handler', required: true)]
    protected string $handler;

    #[Kubernetes\Attribute('kind')]
    protected string|null $kind = 'RuntimeClass';

    #[Kubernetes\Attribute('metadata', type: AttributeType::Model, model: ObjectMeta::class)]
    protected ObjectMeta|null $metadata = null;

    #[Kubernetes\Attribute('overhead', type: AttributeType::Model, model: Overhead::class)]
    protected Overhead|null $overhead = null;

    #[Kubernetes\Attribute('scheduling', type: AttributeType::Model, model: Scheduling::class)]
    protected Scheduling|null $scheduling = null;

    public function __construct(string|null $name, string $handler)
    {
     ...
     */
    public function getOverhead(): Overhead|null
    {
     ...
     * @return static
     */
    public function setOverhead(Overhead $overhead): static
    {
     ...
     */
    public function getScheduling(): Scheduling|null
    {
     ...
     * @return static
     */
    public function setScheduling(Scheduling $scheduling): static
    {
