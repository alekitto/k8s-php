...
class CustomResourceDefinitionList implements IteratorAggregate
{
    ...
    protected string|null $apiVersion = 'apiextensions.k8s.io/v1';

    /** @var iterable|CustomResourceDefinition[] */
    #[Kubernetes\Attribute('items', type: AttributeType::Collection, model: CustomResourceDefinition::class, required: true)]
    protected iterable $items;

    #[Kubernetes\Attribute('kind')]
    protected string|null $kind = 'CustomResourceDefinitionList';
    ...
    /** @return static */
    public function addItems(CustomResourceDefinition $item): static
    {
        if (! $this->items) {
